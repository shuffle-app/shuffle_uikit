...
class UiKitCheckInChip extends StatefulWidget {
  ...
  const UiKitCheckInChip(
      {super.key, required this.onPressed, required this.isChecked});

  @override
  State<UiKitCheckInChip> createState() => _UiKitCheckInChipState();
}

class _UiKitCheckInChipState extends State<UiKitCheckInChip>
  ...
  void initState() {
    ...
    if (!widget.isChecked) {
      ...
      WidgetsBinding.instance
          .addPostFrameCallback((_) => _pageController.jumpToPage(2));
    }
  }
