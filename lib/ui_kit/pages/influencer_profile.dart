              ...
              socialLinks: [
                ...
                context.smallOutlinedButton(
                  data: BaseUiKitButtonData(
                    onPressed: () {},
                    iconInfo: BaseUiKitButtonIconData(
                      iconPath: GraphicsFoundation.instance.svg.socialInstagram.path,
                    ),
                  ),
                ),
              ],
            ...
            child: Column(
              ...
              children: [
                ...
                UiKitInfluencerProfileNewsTile(
                  ...
                  title: '+12 photos',
                  titleDecorationIcon: GraphicsFoundation.instance.svg.photo.path,
                ),
                SpacingFoundation.verticalSpace12,
                UiKitInfluencerProfileNewsTile(
                  onTap: () {
                ...
                UiKitInfluencerProfileNewsTile(
                  ...
                  titleDecorationIcon: GraphicsFoundation.instance.svg.playOutline.path,
                ),
              ],
                ...
                UiKitShowMoreTitledSection(
                  ...
                  content: UiKitContestCard(
                    ...
                    contentProperties: [
                      ...
                      UiKitTag(title: 'Beach', icon: GraphicsFoundation.instance.svg.sun.path),
                      UiKitTag(title: 'Beach', icon: GraphicsFoundation.instance.svg.cocktail2.path),
                    ],
                    contentDescription:
                      ...
                      items: List.generate(
                        ...
                        (index) => InfluencerTopContentData(
                          ...
                          tags: [
                            ...
                            UiKitTag(title: 'Club', icon: ShuffleUiKitIcons.cocktail2),
                            UiKitTag(title: 'Club', icon: ShuffleUiKitIcons.cocktail2),
                            UiKitTag(title: 'Club', icon: ShuffleUiKitIcons.cocktail2),
                            UiKitTag(title: 'Club', icon: ShuffleUiKitIcons.cocktail2),
                            UiKitTag(title: 'Club', icon: ShuffleUiKitIcons.cocktail2),
