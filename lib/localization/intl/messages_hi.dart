...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m63(amount) => "पढ़े ${amount}";

  static String m64(message) => "${message} का जवाब दे रहे हैं";
  ...
  static String m69(type) => "चुनना ${type}";
  ...
  static String m75(separator) => "हमें अपने बारे में${separator}और अधिक बताएं";
  ...
  static String m78(date) => "${date} के लिए शीर्ष घटनाएँ";

  static String m79(amountOfTopDonators, multiplier) =>
      "शीर्ष ${amountOfTopDonators} दानदाताओं को x{गुणक} अंक प्राप्त होते हैं";

  static String m80(separator) =>
      "सर्वोच्च स्थानों का मूल्यांकन किया गया${separator}द्वारा";

  static String m81(type) =>
      "इस फ़ंक्शन का उपयोग करने के लिए कृपया ${type} में अपग्रेड करें";

  static String m82(forNMoney) => "अपग्रेड ${forNMoney}";
  ...
  static String m85(days) =>
      "के भीतर ${days} ${Intl.plural(days, zero: 'दिन', one: 'दिन', two: 'दिन', few: 'दिन', many: 'दिन', other: 'दिन')}";

  static String m86(value) => "${value}  खाली नहीं हो सका";

  static String m87(x, y) => "${x} ने ${y} को आमंत्रित किया";

  static String m88(title) => "{शीर्षक} आवश्यक है";

  static String m89(value) => "${value}  सफलतापूर्वक अद्यतन";
  ...
  static String m93(name) => "क्या आप ${name} को हटाना चाहते हैं?";

  static String m94(name) => "आप ${name} को अब संदेश नहीं भेज सकते";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PleaseSelectAtLeastNReligion": m48,
        ...
        "Products": m59,
        "ProfileAskOrSupportHiwHint": m60,
        ...
        "TopEventsFor": m78,
        "TopNDonatorsReceiveXPoints": m79,
        "TopPlacesRatedBy": m80,
