...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(sum, currency) => "बजट ${sum}${currency}";
  ...
  static String m20(count) => "अपने ग्राहकों के लिए एक USP बनाएं";

  static String m21(x, y) => "अपने ${y} के लिए एक नया ${x} बनाएं";
  ...
  static String m24(x) => "Are you sure want to delete ${x} forever?";

  static String m25(actuallyRaised, goal) =>
      "जमा हुआ ${actuallyRaised}/${goal}\$";

  static String m26(editingType) => "${editingType}  जगह";

  static String m27(inputType) => "${inputType} दर्ज करें";

  static String m28(title) => "Enter ${title}";

  static String m29(x) => "Failed to connect to ${x}";
  ...
  static String m40(formattedPrice) => "${formattedPrice} लिए";

  static String m41(count) => "Free now, ${count}\$ later";

  static String m42(from, to) =>
      "${from} - ${to} ${Intl.plural(from, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m43(helpfulCount) => "उपयोगी ${helpfulCount}";

  static String m44(days) => "${days} दिनों के लिए संकेत प्रणाली सक्षम है";

  static String m45(hours) => "${hours} घंटे पहले";
  ...
  static String m48(invitedPeopleCount) =>
  ...
  static String m50(x) => "Is less than ${x}%";

  static String m51(x) => "is over ${x}%";
  ...
  static String m54(provider) => "${provider} के साथ जारी रखें";
  ...
  static String m57(minutes) => "${minutes} मिनट पहले";

  static String m58(count) =>
      "${count} ${Intl.plural(count, zero: 'mouths', one: 'mouth', two: 'mouths', few: 'mouths', many: 'mouths', other: 'mouths')} ago";

  static String m59(placeIndex) => "${placeIndex} स्थान";

  static String m60(elements) => "अगला ${elements}";

  static String m61(amountOfPeople) => "अगले ${amountOfPeople} लोग";

  static String m62(count) => "प्रस्ताव मूल्य";

  static String m63(count) =>
      "${Intl.plural(count, zero: 'स्थान', one: 'स्थान', two: 'स्थान', few: 'स्थान', many: 'स्थान', other: 'स्थान')}";

  static String m64(x) => "Please enter a valid ${x} link";

  static String m65(religionCount) =>
  ...
  static String m81(amount) => "पढ़े ${amount}";

  static String m82(message) => "${message} का जवाब दे रहे हैं";
  ...
  static String m88(type) => "चुनना ${type}";

  static String m89(x) => "Set up a Refresher for \$${x}";
  ...
  static String m91(x) => "Show ${x} in profile";

  static String m92(item) =>
  ...
  static String m96(x) => "Status: ${x} - Available";

  static String m97(x) =>
      "Status ${x} - Access is restricted or the page is not found";

  static String m98(separator) => "हमें अपने बारे में${separator}और अधिक बताएं";
  ...
  static String m101(date) => "${date} के लिए शीर्ष घटनाएँ";

  static String m102(amountOfTopDonators, multiplier) =>
      "शीर्ष ${amountOfTopDonators} दानदाताओं को x{गुणक} अंक प्राप्त होते हैं";

  static String m103(separator) =>
      "सर्वोच्च स्थानों का मूल्यांकन किया गया${separator}द्वारा";

  static String m104(x) => "You will send ${x} to moderation";

  static String m105(type) =>
      "इस फ़ंक्शन का उपयोग करने के लिए कृपया ${type} में अपग्रेड करें";

  static String m106(forNMoney) => "अपग्रेड ${forNMoney}";
  ...
  static String m110(days) =>
      "के भीतर ${days} ${Intl.plural(days, zero: 'दिन', one: 'दिन', two: 'दिन', few: 'दिन', many: 'दिन', other: 'दिन')}";

  static String m111(value) => "${value}  खाली नहीं हो सका";

  static String m112(x) => "${x} Day";

  static String m113(x) => "${x} Hour";

  static String m114(x, y) => "${x} ने ${y} को आमंत्रित किया";

  static String m115(title) => "{शीर्षक} आवश्यक है";

  static String m116(x) => "${x} सफलतापूर्वक सक्रिय";

  static String m117(x) => "${x} सफलतापूर्वक बनाया गया";

  static String m118(value) => "${value}  सफलतापूर्वक अद्यतन";

  static String m119(x) => "${x} Week";

  static String m120(years) =>
  ...
  static String m122(years) =>
      "${years} ${Intl.plural(years, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m123(x) => "आप अपने ${x} को प्रमोशन मेनू में देख सकते हैं";

  static String m124(amountOfInvitedPersons) =>
      "आपने ${amountOfInvitedPersons} लोगों को निमंत्रण भेजा है";

  static String m125(name) => "क्या आप ${name} को हटाना चाहते हैं?";

  static String m126(name) => "आप ${name} को अब संदेश नहीं भेज सकते";

  static String m127(x) =>
      "Your start notification will be shown ${x} times: a week, a day and an hour before the event start";

  static String m128(x) => "in ${x} days";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "FeedFavoritesHiwItems": m31,
    "FeedFeelingsHiwItems": m32,
    ...
    "FindSomeoneCardPoints": m37,
    "FindSomeoneCardSameInterests": m38,
    ...
    "InvitesCount": m47,
    "InvitesNPeopleInfo": m48,
    "InvitesNPeopleTo": m49,
    ...
    "PleaseSelectAtLeastNReligion": m65,
    ...
    "Products": m77,
    "ProfileAskOrSupportHiwHint": m78,
    ...
    "StatusXAvailable": m96,
    "StatusXIsNotAvailable": m97,
    ...
    "TopEventsFor": m101,
    "TopNDonatorsReceiveXPoints": m102,
    "TopPlacesRatedBy": m103,
    ...
    "XCouldNotBeEmpty": m111,
    "XDay": m112,
    "XHour": m113,
    "XInvitesY": m114,
    "XIsRequired": m115,
    "XSuccessfullyActivated": m116,
    "XSuccessfullyCreated": m117,
    "XSuccessfullyUpdated": m118,
    "XWeek": m119,
    "XYearsPlus": m120,
    ...
    "YouCanSeeYourXPromotionMenu": m123,
    ...
    "YouSentInvitationToNPeople": m124,
    "YouSharedTicket": MessageLookupByLibrary.simpleMessage(
      "You shared a ticket",
    ),
    "YouSureToDeleteX": m125,
    "YouWillNoLongerSendMessagesTo": m126,
    ...
    "YourStartNotificationWillBeShownXTimes": m127,
