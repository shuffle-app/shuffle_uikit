...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(x) => "Add at least one ${x} to promote it";

  static String m1(value) => "सभी ${value} सुविधाएँ अब उपलब्ध हैं!";

  static String m2(allowValue) => "अनुमति दें  ${allowValue}";

  static String m3(allowedCharacters) => "अनुमत वर्ण ${allowedCharacters} हैं";

  static String m4(x) => "Are you sure want to archive ${x}?";

  static String m5(x) => "Book it (+${x})";
  ...
  static String m8(sum, currency) => "बजट ${sum}${currency}";
  ...
  static String m12(x) => "The city is automatically detected as ${x}.";

  static String m13(count) =>
      "${Intl.plural(count, zero: 'टिप्पणियाँ', one: 'टिप्पणी', two: 'टिप्पणियाँ', few: 'टिप्पणियाँ', many: 'टिप्पणियाँ', other: 'टिप्पणियाँ')}";

  static String m14(progress) => "वीडियो ${progress}% संक्षेपित कर रहा है";

  static String m15(x) => "Confirm or edit ${x}";
  ...
  static String m19(count) => "${count} Video-Reaction";

  static String m20(x) =>
      "Create a promotion for your ${x} and increase attendance";

  static String m21(count) => "एक यूएसपी बनाएं";

  static String m22(x, y) => "अपने ${y} के लिए एक नया ${x} बनाएं";
  ...
  static String m25(x) => "Are you sure want to delete ${x} forever?";

  static String m26(actuallyRaised, goal) =>
      "जमा हुआ ${actuallyRaised}/${goal}\$";

  static String m27(editingType) => "${editingType}  जगह";

  static String m28(inputType) => "${inputType} दर्ज करें";

  static String m29(title) => "Enter ${title}";

  static String m30(x) => "Failed to connect to ${x}";
  ...
  static String m41(formattedPrice) => "${formattedPrice} लिए";

  static String m42(count) => "Free now, ${count}\$ later";

  static String m43(from, to) =>
      "${from} - ${to} ${Intl.plural(from, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m44(helpfulCount) => "उपयोगी ${helpfulCount}";

  static String m45(days) => "${days} दिनों के लिए संकेत प्रणाली सक्षम है";

  static String m46(hours) => "${hours} घंटे पहले";
  ...
  static String m51(x) => "Is less than ${x}%";

  static String m52(x) => "is over ${x}%";
  ...
  static String m55(provider) => "${provider} के साथ जारी रखें";
  ...
  static String m58(minutes) => "${minutes} मिनट पहले";

  static String m59(count) =>
      "${count} ${Intl.plural(count, zero: 'mouths', one: 'mouth', two: 'mouths', few: 'mouths', many: 'mouths', other: 'mouths')} ago";

  static String m60(placeIndex) => "${placeIndex} स्थान";

  static String m61(elements) => "अगला ${elements}";

  static String m62(amountOfPeople) => "अगले ${amountOfPeople} लोग";

  static String m63(count) => "प्रस्ताव मूल्य";

  static String m64(count) =>
      "${Intl.plural(count, zero: 'स्थान', one: 'स्थान', two: 'स्थान', few: 'स्थान', many: 'स्थान', other: 'स्थान')}";

  static String m65(x) => "Please enter a valid ${x} link";
  ...
  static String m78(x) => "Potential coverage of ${x} people";
  ...
  static String m83(amount) => "पढ़े ${amount}";

  static String m84(message) => "${message} का जवाब दे रहे हैं";
  ...
  static String m90(type) => "चुनना ${type}";
  ...
  static String m93(x) => "Show ${x} in profile";
  ...
  static String m98(x) => "Status: ${x} - Available";

  static String m99(x) =>
      "Status ${x} - Access is restricted or the page is not found";

  static String m100(separator) =>
      "हमें अपने बारे में${separator}और अधिक बताएं";
  ...
  static String m103(x) => "Today\'s summary: ${x}";

  static String m104(date) => "${date} के लिए शीर्ष घटनाएँ";

  static String m105(amountOfTopDonators, multiplier) =>
      "शीर्ष ${amountOfTopDonators} दानदाताओं को x{गुणक} अंक प्राप्त होते हैं";

  static String m106(separator) =>
      "सर्वोच्च स्थानों का मूल्यांकन किया गया${separator}द्वारा";

  static String m107(x) => "You will send ${x} to moderation";

  static String m108(type) =>
      "इस फ़ंक्शन का उपयोग करने के लिए कृपया ${type} में अपग्रेड करें";

  static String m109(forNMoney) => "अपग्रेड ${forNMoney}";
  ...
  static String m114(value) => "${value}  खाली नहीं हो सका";

  static String m115(x) => "${x} Day";

  static String m116(x) => "${x} Hour";

  static String m117(x, y) => "${x} ने ${y} को आमंत्रित किया";

  static String m118(title) => "{शीर्षक} आवश्यक है";

  static String m119(x) => "${x} सफलतापूर्वक सक्रिय";

  static String m120(x) => "${x} सफलतापूर्वक बनाया गया";

  static String m121(value) => "${value}  सफलतापूर्वक अद्यतन";

  static String m122(x) => "${x} Week";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "BookingsPromo": MessageLookupByLibrary.simpleMessage("Bookings"),
    ...
    "ByDefaultYourOfferWillDisplay": MessageLookupByLibrary.simpleMessage(
      "डिफ़ॉल्ट रूप से, आपका प्रस्ताव अपलोड किए गए स्थान फोटो से एक छवि दिखाएगा",
    ),
    "ByDefaultYourReminderWillDisplay": MessageLookupByLibrary.simpleMessage(
      "डिफ़ॉल्ट रूप से, आपकी याद दिलाने वाली एक छवि दिखाएगी जो अपलोड की गई स्थान फोटो से है",
    ),
    ...
    "CheckInHiwSubtitle": MessageLookupByLibrary.simpleMessage(
      "अपने भावना को ठीक करें या उसे बढ़ावा दें!",
    ),
    "CheckInHiwTitle": MessageLookupByLibrary.simpleMessage(
      "उपयुक्त शहरी सामग्री...",
    ),
    ...
    "CompanyAnswered": MessageLookupByLibrary.simpleMessage(
      "कंपनी ने उत्तर दिया",
    ),
    ...
    "CredentialsCodeVerificationSubtitle": MessageLookupByLibrary.simpleMessage(
      "कृपया उस ईमेल पते पर भेजे गए कोड को दर्ज करें",
    ),
    ...
    "CredentialsVerificationTitle": MessageLookupByLibrary.simpleMessage(
      "आपको खुश देखकर अच्छा लगा",
    ),
    "CropHorizontal": MessageLookupByLibrary.simpleMessage(
      "क्षैतिज करने के लिए",
    ),
    "CropVertical": MessageLookupByLibrary.simpleMessage("लंबवत करने के लिए"),
    ...
    "DeletePromotion": MessageLookupByLibrary.simpleMessage("Delete promotion"),
    ...
    "EditPromotion": MessageLookupByLibrary.simpleMessage("Edit promotion"),
    ...
    "EvenHigher": MessageLookupByLibrary.simpleMessage("even higher"),
    "Event": MessageLookupByLibrary.simpleMessage("घटना"),
    "EventPromo": MessageLookupByLibrary.simpleMessage("Event"),
    ...
    "FaqUnderDev": MessageLookupByLibrary.simpleMessage(
      "सामान्य प्रश्न के लिए अनुरोध जमा किया जा रहा है।\nविकास के अधीन",
    ),
    ...
    "FeedbackPluralNoNumber": MessageLookupByLibrary.simpleMessage(
      "प्रतिक्रिया",
    ),
    "Feedbacks": m36,
    ...
    "Invitations": MessageLookupByLibrary.simpleMessage("आमंत्रण"),
    ...
    "InviteMore": MessageLookupByLibrary.simpleMessage(
      "और अधिक को आमंत्रित करें",
    ),
    ...
    "InvitesYouTo": MessageLookupByLibrary.simpleMessage(
    ...
    "MinAgoX": MessageLookupByLibrary.simpleMessage("min ago"),
    "MinutesAgo": m58,
    ...
    "NoBookingsYet": MessageLookupByLibrary.simpleMessage(
      "अब तक कोई बुकिंग नहीं",
    ),
    "NoConnection": MessageLookupByLibrary.simpleMessage(
      "क्षमा करें, कोई इंटरनेट कनेक्शन नहीं",
    ),
    "NoDateSelected": MessageLookupByLibrary.simpleMessage(
      "कोई दिनांक चयनित नहीं",
    ),
    "NoEndTime": MessageLookupByLibrary.simpleMessage("कोई समाप्ति समय नहीं"),
    ...
    "OfficeAppartmentNumber": MessageLookupByLibrary.simpleMessage(
      "कार्यालय या अपार्टमेंट नंबर",
    ),
    "OhYeahSure": MessageLookupByLibrary.simpleMessage("हां बिल्कुल!"),
    ...
    "OnboardingSlide2": MessageLookupByLibrary.simpleMessage(
      "व्यापार और अनुसंधान करने के लिए",
    ),
    ...
    "PausePromotion": MessageLookupByLibrary.simpleMessage("Pause promotion"),
    "Paused": MessageLookupByLibrary.simpleMessage("रोका हुआ"),
    ...
    "PersonalizeYourOffer": MessageLookupByLibrary.simpleMessage(
      "अपने प्रस्ताव को व्यक्तिगत बनाएं",
    ),
    "PersonalizeYourReminder": MessageLookupByLibrary.simpleMessage(
      "अपनी याद दिलाने वाली को व्यक्तिगत बनाएं",
    ),
    ...
    "PlacePromo": MessageLookupByLibrary.simpleMessage("Place"),
    ...
    "Reactions": m82,
    "ReactionsBy": MessageLookupByLibrary.simpleMessage(
      "प्रतिक्रिया\nके द्वारा",
    ),
    ...
    "SecAgoX": MessageLookupByLibrary.simpleMessage("sec ago"),
    ...
    "SetWorkHours": MessageLookupByLibrary.simpleMessage(
      "कार्य का समय निर्धारित करें",
    ),
    ...
    "SkipIt": MessageLookupByLibrary.simpleMessage("छोड़ें"),
    ...
    "StartToExplore": MessageLookupByLibrary.simpleMessage(
    ...
    "SwitchAnyTime": MessageLookupByLibrary.simpleMessage(
      "आप इसे अपनी प्रोफ़ाइल सेटिंग्स में किसी भी समय स्विच कर सकते हैं",
    ),
    ...
    "TapToSeeMore": MessageLookupByLibrary.simpleMessage(
      "अधिक देखने के लिए टैप करें",
    ),
    ...
    "TheBestParties": MessageLookupByLibrary.simpleMessage(
      "सबसे अच्छी पार्टियां",
    ),
    "TheBestTechConf": MessageLookupByLibrary.simpleMessage(
      "सर्वश्रेष्ठ तकनीकी सम्मेलन",
    ),
    ...
    "ToExtendYourUseSelectPayment": MessageLookupByLibrary.simpleMessage(
      "अपने उपयोग को बढ़ाने के लिए भुगतान का चयन करें",
    ),
    "ToFavorites": MessageLookupByLibrary.simpleMessage("पसंदीदा में"),
    ...
    "UploadingVideo": MessageLookupByLibrary.simpleMessage(
    ...
    "VideoFileNotCut": MessageLookupByLibrary.simpleMessage(
      "वीडियो फ़ाइल को काटा नहीं जा सका",
    ),
    ...
    "VideoReactions": MessageLookupByLibrary.simpleMessage(
      "वीडियो प्रतिक्रियाएँ",
    ),
    ...
    "YourNotificationWillBeShown": MessageLookupByLibrary.simpleMessage(
      "आपकी अधिसूचना 3 बार प्रति सप्ताह दिखाई जाएगी निर्दिष्ट मान्यता की अवधि के दौरान, अधिकतम 1 व्यक्ति प्रति दिखाई जाएगी।",
    ),
