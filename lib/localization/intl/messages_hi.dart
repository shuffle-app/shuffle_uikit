...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m71(amount) => "पढ़े ${amount}";

  static String m72(message) => "${message} का जवाब दे रहे हैं";
  ...
  static String m78(type) => "चुनना ${type}";
  ...
  static String m80(x) => "Show ${x} in profile";
  ...
  static String m85(x) => "Status: ${x} - Available";

  static String m86(x) =>
      "Status ${x} - Access is restricted or the page is not found";

  static String m87(separator) => "हमें अपने बारे में${separator}और अधिक बताएं";
  ...
  static String m90(date) => "${date} के लिए शीर्ष घटनाएँ";

  static String m91(amountOfTopDonators, multiplier) =>
      "शीर्ष ${amountOfTopDonators} दानदाताओं को x{गुणक} अंक प्राप्त होते हैं";

  static String m92(separator) =>
      "सर्वोच्च स्थानों का मूल्यांकन किया गया${separator}द्वारा";

  static String m93(x) => "You will send ${x} to moderation";

  static String m94(type) =>
      "इस फ़ंक्शन का उपयोग करने के लिए कृपया ${type} में अपग्रेड करें";

  static String m95(forNMoney) => "अपग्रेड ${forNMoney}";
  ...
  static String m98(days) =>
      "के भीतर ${days} ${Intl.plural(days, zero: 'दिन', one: 'दिन', two: 'दिन', few: 'दिन', many: 'दिन', other: 'दिन')}";

  static String m99(value) => "${value}  खाली नहीं हो सका";

  static String m100(x, y) => "${x} ने ${y} को आमंत्रित किया";

  static String m101(title) => "{शीर्षक} आवश्यक है";

  static String m102(x) => "${x} सफलतापूर्वक सक्रिय";

  static String m103(x) => "${x} सफलतापूर्वक बनाया गया";

  static String m104(value) => "${value}  सफलतापूर्वक अद्यतन";

  static String m105(years) =>
      "${years}+ ${Intl.plural(years, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m106(years) =>
      "${years} ${Intl.plural(years, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m107(x) => "आप अपने ${x} को प्रमोशन मेनू में देख सकते हैं";

  static String m108(amountOfInvitedPersons) =>
      "आपने ${amountOfInvitedPersons} लोगों को निमंत्रण भेजा है";

  static String m109(name) => "क्या आप ${name} को हटाना चाहते हैं?";

  static String m110(name) => "आप ${name} को अब संदेश नहीं भेज सकते";

  static String m111(x) => "in ${x} days";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "Products": m67,
        "ProfileAskOrSupportHiwHint": m68,
        ...
        "StatusXAvailable": m85,
        "StatusXIsNotAvailable": m86,
        ...
        "TopEventsFor": m90,
        "TopNDonatorsReceiveXPoints": m91,
        "TopPlacesRatedBy": m92,
        ...
        "XCouldNotBeEmpty": m99,
        "XInvitesY": m100,
        "XIsRequired": m101,
        "XSuccessfullyActivated": m102,
        "XSuccessfullyCreated": m103,
        "XSuccessfullyUpdated": m104,
        "XYearsPlus": m105,
        ...
        "YouCanSeeYourXPromotionMenu": m107,
        ...
        "YouSentInvitationToNPeople": m108,
        "YouSharedTicket":
            MessageLookupByLibrary.simpleMessage("You shared a ticket"),
        "YouSureToDeleteX": m109,
        "YouWillNoLongerSendMessagesTo": m110,
