...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) => "सभी ${value} सुविधाएँ अब उपलब्ध हैं!";

  static String m1(allowValue) => "अनुमति दें  ${allowValue}";

  static String m2(allowedCharacters) => "अनुमत वर्ण ${allowedCharacters} हैं";

  static String m3(count) =>
      "${count} ${Intl.plural(count, zero: 'बुकिंग', one: 'बुकिंग', two: 'बुकिंग', few: 'बुकिंग', many: 'बुकिंग', other: 'बुकिंग')}";

  static String m4(count) =>
      "${Intl.plural(count, zero: 'बुकिंग', one: 'बुकिंग', two: 'बुकिंग', few: 'बुकिंग', many: 'बुकिंग', other: 'बुकिंग')}";

  static String m5(count) =>
      "${count} ${Intl.plural(count, zero: 'कार्ड', one: 'कार्ड', two: 'कार्ड', few: 'कार्ड', many: 'कार्ड', other: 'कार्ड')} ${Intl.plural(count, zero: 'ओपनिंग', one: 'ओपनिंग', two: 'ओपनिंग', few: 'ओपनिंग', many: 'ओपनिंग', other: 'ओपनिंग')}";

  static String m6(creationDate, deletionDate) => "बनाया गया है ${creationDate}।\nहटाया जाएगा ${deletionDate}";
  ...
  static String m9(progress) => "वीडियो ${progress}% संक्षेपित कर रहा है";
  ...
  static String m12(count) => "${count} Reviews";

  static String m13(count) => "${count} Video-Reaction";

  static String m14(x, y) => "Create a new ${x} for your ${y} and increase attendance";

  static String m15(days) =>
      "${Intl.plural(days, zero: 'दिन', one: 'दिन', two: 'दिन', few: 'दिन', many: 'दिन', other: 'दिन')}";

  static String m16(actuallyRaised, goal) => "जमा हुआ ${actuallyRaised}/${goal}\$";

  static String m17(editingType) => "${editingType}  जगह";

  static String m18(inputType) => "${inputType} दर्ज करें";
  ...
  static String m29(formattedPrice) => "${formattedPrice} लिए";

  static String m30(from, to) =>
      "${from} - ${to} ${Intl.plural(from, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m31(helpfulCount) => "उपयोगी ${helpfulCount}";

  static String m32(days) => "${days} दिनों के लिए संकेत प्रणाली सक्षम है";

  static String m33(hours) => "${hours} घंटे पहले";
  ...
  static String m36(invitedPeopleCount) =>
  ...
  static String m39(provider) => "${provider} के साथ जारी रखें";
  ...
  static String m42(minutes) => "${minutes} मिनट पहले";

  static String m43(placeIndex) => "${placeIndex} स्थान";

  static String m44(elements) => "अगला ${elements}";

  static String m45(amountOfPeople) => "अगले ${amountOfPeople} लोग";

  static String m45(count) =>
      "${Intl.plural(count, zero: 'स्थान', one: 'स्थान', two: 'स्थान', few: 'स्थान', many: 'स्थान', other: 'स्थान')}";

  static String m46(religionCount) => "कृपया कम से कम ${religionCount} धर्म का चयन करें";
  ...
  static String m60(amount) => "पढ़े ${amount}";

  static String m61(message) => "${message} का जवाब दे रहे हैं";
  ...
  static String m66(type) => "चुनना ${type}";
  ...
  static String m72(separator) => "हमें अपने बारे में${separator}और अधिक बताएं";
  ...
  static String m75(date) => "${date} के लिए शीर्ष घटनाएँ";

  static String m76(amountOfTopDonators, multiplier) =>
      "शीर्ष ${amountOfTopDonators} दानदाताओं को x{गुणक} अंक प्राप्त होते हैं";

  static String m77(separator) => "सर्वोच्च स्थानों का मूल्यांकन किया गया${separator}द्वारा";

  static String m78(type) => "इस फ़ंक्शन का उपयोग करने के लिए कृपया ${type} में अपग्रेड करें";

  static String m79(forNMoney) => "अपग्रेड ${forNMoney}";
  ...
  static String m82(days) =>
      "के भीतर ${days} ${Intl.plural(days, zero: 'दिन', one: 'दिन', two: 'दिन', few: 'दिन', many: 'दिन', other: 'दिन')}";

  static String m83(value) => "${value}  खाली नहीं हो सका";

  static String m84(x, y) => "${x} ने ${y} को आमंत्रित किया";

  static String m85(title) => "{शीर्षक} आवश्यक है";

  static String m86(value) => "${value}  सफलतापूर्वक अद्यतन";

  static String m87(years) =>
      "${years}+ ${Intl.plural(years, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m88(years) =>
      "${years} ${Intl.plural(years, zero: 'वर्ष', one: 'वर्ष', two: 'वर्ष', few: 'वर्ष', many: 'वर्ष', other: 'वर्ष')}";

  static String m89(amountOfInvitedPersons) => "आपने ${amountOfInvitedPersons} लोगों को निमंत्रण भेजा है";

  static String m90(name) => "क्या आप ${name} को हटाना चाहते हैं?";

  static String m91(name) => "आप ${name} को अब संदेश नहीं भेज सकते";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "AboutUs": MessageLookupByLibrary.simpleMessage("हमारे बारे में"),
        "AcceptDonations":
            MessageLookupByLibrary.simpleMessage("दान स्वीकार करें या दूसरों की सपने पूरे करने में मदद करें"),
        ...
        "AddFeedbackFieldHint": MessageLookupByLibrary.simpleMessage("बताएं कि आपको क्या पसंद आया या याद रहा"),
        "AddFeedbackFieldTitle": MessageLookupByLibrary.simpleMessage("अपने अनुभव का वर्णन करें"),
        ...
        "AddReviewFieldHint": MessageLookupByLibrary.simpleMessage("एक उपयोगी जोड़ना लिखें"),
        "AddReviewFieldTitle": MessageLookupByLibrary.simpleMessage("अपने अनुभव का वर्णन करें"),
        "AddReviewPopOverText":
            MessageLookupByLibrary.simpleMessage("एक समीक्षा जोड़ें जो अन्य आगंतुकों के लिए उपयोगी होगी"),
        "AddToMyFavorites": MessageLookupByLibrary.simpleMessage("मेरे पसंदीदा में जोड़ें"),
        "AddToPersonalTop": MessageLookupByLibrary.simpleMessage("व्यक्तिगत शीर्ष पर जोड़ें"),
        "AddYourselfToList": MessageLookupByLibrary.simpleMessage("स्वयं को सूची में जोड़ें"),
        ...
        "AllAppNotification": MessageLookupByLibrary.simpleMessage("सभी ऐप सूचनाएँ"),
        ...
        "AllowGeolocation": MessageLookupByLibrary.simpleMessage("जियोलोकेशन की अनुमति दें"),
        "AllowLocationServicesToUseThisFunction":
            MessageLookupByLibrary.simpleMessage("स्थान सेवाओं को इस फ़ंक्शन का उपयोग करने दें"),
        "AllowX": m1,
        "AllowedCaracters": m2,
        ...
        "AlreadyInvited": MessageLookupByLibrary.simpleMessage("कृपया अपने चयन और दूसरों की भावनाओं का सम्मान करें"),
        ...
        "AreYouSureYouWantToDeleteYourAccount":
            MessageLookupByLibrary.simpleMessage("क्या आप वाकई अपना खाता हटाना चाहते हैं?"),
        "AreYouSureYouWantToDeleteYourCompanyProfile":
            MessageLookupByLibrary.simpleMessage("क्या आप वाकई अपनी कंपनी प्रोफ़ाइल हटाना चाहते हैं?"),
        "AreYouSureYouWantToLogOut": MessageLookupByLibrary.simpleMessage("क्या आप वाकई लॉग आउट करना चाहते हैं?"),
        "AskForDonations": MessageLookupByLibrary.simpleMessage("दान माँगें"),
        "AskOrSupport": MessageLookupByLibrary.simpleMessage("पूछें या समर्थन करें"),
        ...
        "BookingLimitPerOne": MessageLookupByLibrary.simpleMessage("एक व्यक्ति प्रति बुकिंग सीमा"),
        "BookingList": MessageLookupByLibrary.simpleMessage("बुकिंग सूची"),
        "Bookings": m4,
        "BookingsAndInvites": MessageLookupByLibrary.simpleMessage("बुकिंग और आमंत्रण"),
        ...
        "BuildYOurBusiness": MessageLookupByLibrary.simpleMessage("अपने व्यापार को बढ़ाएं"),
        ...
        "ByContinuingYouAcceptThe": MessageLookupByLibrary.simpleMessage("जारी रखकर आप स्वीकार करते हैं"),
        ...
        "CantSeePublicProfileMessage":
            MessageLookupByLibrary.simpleMessage("आप इस प्रोफ़ाइल को एक इन्फ्लुएंसर बनने पर देख सकते हैं"),
        "CardOpening": m5,
        "Categories": MessageLookupByLibrary.simpleMessage("श्रेणियाँ"),
        "Category": MessageLookupByLibrary.simpleMessage("श्रेणी"),
        "ChallengeFeelings": MessageLookupByLibrary.simpleMessage("भावनाओं का चुनौती"),
        ...
        "CheckInHiwHint": m7,
        "CheckInHiwSubtitle": MessageLookupByLibrary.simpleMessage("अपने भावना को ठीक करें या उसे बढ़ावा दें!"),
        "CheckInHiwTitle": MessageLookupByLibrary.simpleMessage("उपयुक्त शहरी सामग्री..."),
        "CheckItOut": MessageLookupByLibrary.simpleMessage("इसे जांचें"),
        ...
        "ClickEnterToSearch": MessageLookupByLibrary.simpleMessage("क्लिक करें दर्ज खोज करने के लिए"),
        ...
        "CompanyCredentials": MessageLookupByLibrary.simpleMessage("कंपनी क्रेडेंशियल्स"),
        "CompanyName": MessageLookupByLibrary.simpleMessage("कंपनी का नाम"),
        "CompanyPosition": MessageLookupByLibrary.simpleMessage("कंपनी की स्थिति"),
        ...
        "CompanyPresentationSlider7":
            MessageLookupByLibrary.simpleMessage("आप आंतरिक लक्षित विज्ञापन प्रणाली का उपयोग कर सकते हैं"),
        ...
        "CompressingVideo": MessageLookupByLibrary.simpleMessage("वीडियो को संक्षेपित करना"),
        ...
        "ContentIdNotProvidedError": MessageLookupByLibrary.simpleMessage("सामग्री आईडी प्रदान नहीं की गई"),
        "ContentOffers": m11,
        ...
        "ContentThatIsAvailableForYouToViewWillAppearHere":
            MessageLookupByLibrary.simpleMessage("Content that is available for you to view will appear here"),
        ...
        "ConvenientClearAndUseful": MessageLookupByLibrary.simpleMessage("सुविधाजनक, स्पष्ट और उपयोगी"),
        "CouldntFindInvite": MessageLookupByLibrary.simpleMessage("आमंत्रण नहीं मिल सका"),
        "CountReviews": m12,
        ...
        "CreateReminderDescription":
            MessageLookupByLibrary.simpleMessage("अपने ग्राहकों के लिए मुफ्त याद दिलाने के लिए"),
        ...
        "CreateYourEventAndInvitePeople":
            MessageLookupByLibrary.simpleMessage("अपनी घटना बनाएं और लोगों को आमंत्रित करें"),
        "CreateYourPlaceAndInvitePeople":
            MessageLookupByLibrary.simpleMessage("अपना स्थान बनाएं और लोगों को आमंत्रित करें"),
        "CredentialsCodeVerificationSubtitle":
            MessageLookupByLibrary.simpleMessage("कृपया उस ईमेल पते पर भेजे गए कोड को दर्ज करें"),
        "CredentialsVerificationPrompt":
            MessageLookupByLibrary.simpleMessage("पहुँच प्राप्त करने के लिए पहले लॉग इन करें"),
        "CredentialsVerificationTitle": MessageLookupByLibrary.simpleMessage("आपको खुश देखकर अच्छा लगा"),
        ...
        "DeleteFolderAlert": MessageLookupByLibrary.simpleMessage("क्या आप स्टैक हटाना चाहते हैं?"),
        ...
        "DescribeYourBusiness": MessageLookupByLibrary.simpleMessage("अपने व्यापार का विवरण दें"),
        "DescribeYourClaim": MessageLookupByLibrary.simpleMessage("अपने दावे का वर्णन करें"),
        "DescribeYourIssue": MessageLookupByLibrary.simpleMessage("अपने मामले का वर्णन करें"),
        "DescribeYourWishes": MessageLookupByLibrary.simpleMessage("अपनी इच्छाओं का वर्णन करें"),
        "DescribeYourself": MessageLookupByLibrary.simpleMessage("स्वयं का विवरण दें"),
        "Description": MessageLookupByLibrary.simpleMessage("विवरण"),
        "Details": MessageLookupByLibrary.simpleMessage("विवरण"),
        "DifferentNumberOfPoints": MessageLookupByLibrary.simpleMessage("अलग संख्या के अंक"),
        ...
        "DontLiveAlone":
            MessageLookupByLibrary.simpleMessage("अकेले न रहें, उन लोगों की सदस्यता लें जिन्हें आप पसंद करते हैं"),
        ...
        "EditingTypePlace": m17,
        "Email": MessageLookupByLibrary.simpleMessage("ईमेल"),
        "EmailVerification": MessageLookupByLibrary.simpleMessage("ईमेल सत्यापन"),
        "EnableHintSystem": MessageLookupByLibrary.simpleMessage("संकेत प्रणाली सक्षम करें"),
        "EnterExternalLink": MessageLookupByLibrary.simpleMessage("बाह्य लिंक दर्ज करें"),
        "EnterInputType": m18,
        "EnterLocation": MessageLookupByLibrary.simpleMessage("स्थान दर्ज करें"),
        "EnterNewPassword": MessageLookupByLibrary.simpleMessage("नया पासवर्ड दर्ज करें"),
        "EnterPlaceAddressPrompt": MessageLookupByLibrary.simpleMessage("कृपया स्थान का पता दर्ज करें"),
        ...
        "EntertainmentSpecialist": MessageLookupByLibrary.simpleMessage("मनोरंजन विशेषज्ञ"),
        "ErrorOccured": MessageLookupByLibrary.simpleMessage("त्रुटि हुई"),
        "ErrorOccuredWithoutMessage": MessageLookupByLibrary.simpleMessage("संदेश के बिना त्रुटि हुई"),
        ...
        "EventsCount": m19,
        "EventsReminders": MessageLookupByLibrary.simpleMessage("घटनाएँ और याद दिलाने वाले"),
        ...
        "FaqUnderDev":
            MessageLookupByLibrary.simpleMessage("सामान्य प्रश्न के लिए अनुरोध जमा किया जा रहा है।\nविकास के अधीन"),
        "Favorites": MessageLookupByLibrary.simpleMessage("पसंदीदा"),
        "FeaturesEnableGeolocation": MessageLookupByLibrary.simpleMessage("सुविधाएँ जियोलोकेशन सक्षम करती हैं"),
        "FeedFavoritesHiwItems": m20,
        "FeedFeelingsHiwItems": m21,
        "FeedFeelingsHiwSubtitle": MessageLookupByLibrary.simpleMessage("आपको बिल्कुल वह मिलता है जो आपको चाहिए"),
        "FeedFeelingsHiwTitle": MessageLookupByLibrary.simpleMessage("आधारित है..."),
        "FeedNichesHiwItems": m22,
        "FeedNichesHiwSubtitle": MessageLookupByLibrary.simpleMessage("आपको बिल्कुल वह मिलता है जो आपको चाहिए"),
        "FeedNichesHiwTitle": MessageLookupByLibrary.simpleMessage("बड़ा मैच..."),
        "FeedRandomizerHiwItems": m23,
        "FeedRandomizerHiwSubtitle": MessageLookupByLibrary.simpleMessage("आप दबाते हैं और यादृच्छिक प्राप्त करते हैं"),
        "FeedRandomizerHiwTitle": MessageLookupByLibrary.simpleMessage("यादृच्छिकता..."),
        "Feedback": MessageLookupByLibrary.simpleMessage("प्रतिक्रिया"),
        "FeedbackAddedSuccessfullyMessage":
            MessageLookupByLibrary.simpleMessage("आपकी प्रतिक्रिया सफलतापूर्वक जोड़ी गई है"),
        "Feedbacks": m24,
        "Feeling": MessageLookupByLibrary.simpleMessage("लग रहा है"),
        "FeelingsGuesses": m25,
        "Female": MessageLookupByLibrary.simpleMessage("महिला"),
        "FileNotExistsMessage": MessageLookupByLibrary.simpleMessage("फ़ाइल मौजूद नहीं है"),
        "Filters": MessageLookupByLibrary.simpleMessage("फ़िल्टर"),
        "FindSomeoneCardPoints": m26,
        "FindSomeoneCardSameInterests": m27,
        "FindSomeoneToHangOutWith": MessageLookupByLibrary.simpleMessage("किसी के साथ घूमने के लिए खोजें"),
        "FindSomeoneToNetworkWith": MessageLookupByLibrary.simpleMessage("नेटवर्किंग करने के लिए किसी को खोजें"),
        "FocusOfLight": MessageLookupByLibrary.simpleMessage("प्रकाश का केंद्र"),
        ...
        "GlobalAlertText": MessageLookupByLibrary.simpleMessage("केवल प्रकाशित को वैश्विक बनाया जा सकता है"),
        "Go": MessageLookupByLibrary.simpleMessage("आगे बढ़ो"),
        "GoAhead": MessageLookupByLibrary.simpleMessage("आगे बढ़ें"),
        "GoAheadAndGrowYourBusiness": MessageLookupByLibrary.simpleMessage("आगे बढ़ें और अपना व्यवसाय बढ़ाएं"),
        ...
        "GoToSettings": MessageLookupByLibrary.simpleMessage("सेटिंग्स में जाओ"),
        "GreatInterviewWithOwner": MessageLookupByLibrary.simpleMessage("मालिक के साथ महान साक्षात्कार"),
        "Guess": MessageLookupByLibrary.simpleMessage("अनुमान"),
        "HallOfFame": MessageLookupByLibrary.simpleMessage("प्रशंसा की दीवार"),
        "HardToAnswer": MessageLookupByLibrary.simpleMessage("जवाब देना मुश्किल"),
        "Hardcore": MessageLookupByLibrary.simpleMessage("हार्डकोर"),
        "HealthKit": MessageLookupByLibrary.simpleMessage("स्वास्थ्य किट"),
        "HealthRandomAlert":
            MessageLookupByLibrary.simpleMessage("स्वास्थ्य किट उपयोग की अनुमति दें अन्यथा परिणाम यादृच्छिक होगा"),
        "Helpful": MessageLookupByLibrary.simpleMessage("उपयोगी"),
        "HelpfulNCount": m31,
        "Hindu": MessageLookupByLibrary.simpleMessage("हिंदू"),
        "HintAverageBill": MessageLookupByLibrary.simpleMessage("मूल्य या मूल्य सीमा का चयन करें"),
        "HintNumberEventsForPro":
            MessageLookupByLibrary.simpleMessage("3 घटनाएँ उपलब्ध हैं और अधिक कीमत के लिए अधिक जोड़ें"),
        "HintSystemDisabled": MessageLookupByLibrary.simpleMessage("संकेत प्रणाली अक्षम है"),
        "HintSystemEnabled": m32,
        "HoursAgo": m33,
        "HowAreYouFeelingThisMorning": MessageLookupByLibrary.simpleMessage("आप आज सुबह कैसा महसूस कर रहे हैं?"),
        "HowAreYouFeelingToday": MessageLookupByLibrary.simpleMessage("आज आप कैसा महसूस कर रहे हैं?"),
        "HowAreYouFeelingTonight": MessageLookupByLibrary.simpleMessage("आज रात आप कैसा महसूस कर रहे हैं?"),
        "HowItWorks": MessageLookupByLibrary.simpleMessage("यह कैसे\nकाम करता है"),
        "HowMuchDoYouWantToDonate": MessageLookupByLibrary.simpleMessage("आप कितना \$ दान करना चाहते हैं?"),
        ...
        "IncorrectLoginOrPassword": MessageLookupByLibrary.simpleMessage("गलत लॉगिन या पासवर्ड"),
        ...
        "InfluencerSubscriptionFeature3":
            MessageLookupByLibrary.simpleMessage("काम करने के लिए उपकरणों का एक सेट प्राप्त करें "),
        "InfluencerSubscriptionFeature3v1":
            MessageLookupByLibrary.simpleMessage(" सामग्री और अपने दर्शकों के साथ बातचीत करना"),
        "InfluencerSubscriptionFeature4":
            MessageLookupByLibrary.simpleMessage("अपने क्षेत्र में एक विचार नेता बनें और प्रतिष्ठा कमाएं"),
        "InfluencerSubscriptionFeature5":
            MessageLookupByLibrary.simpleMessage("लोगों के चयन पर प्रभाव डालें और स्थानों और घटनाओं का महत्व बढ़ाएं"),
        "InfluencerSubscriptionFeature6": MessageLookupByLibrary.simpleMessage("मुद्रीकरण"),
        ...
        "InventoryItems": MessageLookupByLibrary.simpleMessage("इन्वेंटरी आइटम"),
        "InvitationsCanBeViewedInPrivateMessages":
            MessageLookupByLibrary.simpleMessage("निमंत्रण निजी संदेशों में देखे जा सकते हैं"),
        "Invite": MessageLookupByLibrary.simpleMessage("आमंत्रित करना"),
        "InviteList": MessageLookupByLibrary.simpleMessage("आमंत्रण सूची"),
        "InviteMore": MessageLookupByLibrary.simpleMessage("और अधिक को आमंत्रित करें"),
        "InvitePeople": MessageLookupByLibrary.simpleMessage("लोगो को निमंत्रण भेजो"),
        "InviteToFavoritePlaces": MessageLookupByLibrary.simpleMessage("पसंदीदा स्थानों पर आमंत्रित करें"),
        "InvitedPeople": MessageLookupByLibrary.simpleMessage("आमंत्रित लोग"),
        "InvitesCount": m34,
        "InvitesNPeopleInfo": m35,
        "InvitesNPeopleTo": m36,
        ...
        "LimitLessSumLimitsSubs":
            MessageLookupByLibrary.simpleMessage("सब्स के लिए सीमा कुल सीमा की जोड़ से कम होनी चाहिए"),
        "LimitLessTotalLimit": MessageLookupByLibrary.simpleMessage("एक के लिए सीमा को कुल सीमा से कम होना चाहिए"),
        "Loading": MessageLookupByLibrary.simpleMessage("लोड हो रहा है..."),
        "Location": MessageLookupByLibrary.simpleMessage("जगह"),
        "LocationIsRequired": MessageLookupByLibrary.simpleMessage("चेक इन करने के लिए स्थान आवश्यक है"),
        "Locked": MessageLookupByLibrary.simpleMessage("लॉक किया गया"),
        "LogIn": MessageLookupByLibrary.simpleMessage("Log in"),
        "LogInTo": MessageLookupByLibrary.simpleMessage("Log in"),
        "LogInWithEmail": MessageLookupByLibrary.simpleMessage("ईमेल के साथ लॉगिन करें"),
        "LoginBenefits": m36,
        "LoginInAppDaysInARow": m37,
        "LoginWith": m38,
        "Logo": MessageLookupByLibrary.simpleMessage("प्रतीक चिन्ह"),
        "LogoUploadFiles": MessageLookupByLibrary.simpleMessage("लोगो (फ़ाइलें अपलोड करें)"),
        "LovelyTouchAmazingInteraction": MessageLookupByLibrary.simpleMessage("प्यारा-स्पर्श अद्भुत\nइंटरैक्शन"),
        "LuckyCoin": MessageLookupByLibrary.simpleMessage("भाग्यशाली सिक्का"),
        "LuckyCoinDescription": MessageLookupByLibrary.simpleMessage(
            "जब तक आपके पास इसे इन्वेंटरी में रखा है, भाग्य आपके साथ है। इसे घुमाएं, इसे घुमाएं, इसे छूने के लिए भाग्य की ऊर्जा से भर दें।"),
        "MakeSureYouAreCloseToMakeCheckIn":
            MessageLookupByLibrary.simpleMessage("सुनिश्चित करें कि आप निकट हैं और फिर से चेक इन करें"),
        "Male": MessageLookupByLibrary.simpleMessage("पुरुष"),
        "Members": m40,
        "MembersCount": m41,
        "Message": MessageLookupByLibrary.simpleMessage("संदेश"),
        "MessageNotFound": MessageLookupByLibrary.simpleMessage("संदेश नहीं मिला"),
        ...
        "MoreAboutThisEvent": MessageLookupByLibrary.simpleMessage("इस घटना के बारे में और जानें"),
        "MoreAboutThisPlace": MessageLookupByLibrary.simpleMessage("इस स्थान के बारे में और जानें"),
        "MostActiveAgeSegment": MessageLookupByLibrary.simpleMessage("सबसे सक्रिय आयु सेगमेंट"),
        "MustSelectVideo": MessageLookupByLibrary.simpleMessage("आपको कम से कम एक वीडियो चुनना होगा"),
        "MustVisitTechnologyConf": MessageLookupByLibrary.simpleMessage("प्रौद्योगिकी सम्मेलन का दौरा करना चाहिए"),
        ...
        "MyReactions": MessageLookupByLibrary.simpleMessage("मेरी प्रतिक्रियाएँ"),
        ...
        "NewFollowers": MessageLookupByLibrary.simpleMessage("नए अनुयायी"),
        "NewLocationHasOpenedToday":
            MessageLookupByLibrary.simpleMessage("आज एक नया स्थान खुल गया है ।  आओ! आप इसे पसंद करेंगे!"),
        ...
        "NicknameIsTakenTryAnotherOne": MessageLookupByLibrary.simpleMessage("उपनाम लिया जाता है, एक और प्रयास करें"),
        "NoBookingsYet": MessageLookupByLibrary.simpleMessage("अब तक कोई बुकिंग नहीं"),
        "NoConnection": MessageLookupByLibrary.simpleMessage("क्षमा करें, कोई इंटरनेट कनेक्शन नहीं"),
        "NoDateSelected": MessageLookupByLibrary.simpleMessage("कोई दिनांक चयनित नहीं"),
        "NoFavoritesFound": MessageLookupByLibrary.simpleMessage("कोई पसंदीदा नहीं मिला"),
        "NoFeedbacksYet":
            MessageLookupByLibrary.simpleMessage("शफल में स्थानों और घटनाओं का दौरा करें और अपने अनुभव साझा करें"),
        ...
        "NoMessagesYet": MessageLookupByLibrary.simpleMessage("अब तक कोई संदेश नहीं"),
        "NoPeopleAvailableToInvite":
            MessageLookupByLibrary.simpleMessage("आमंत्रित करने के लिए कोई लोग उपलब्ध नहीं हैं"),
        ...
        "NoReactionsMessage": MessageLookupByLibrary.simpleMessage("अब तक कोई प्रतिक्रिया नहीं है, पहले वाले बनें"),
        "NoReviewsMessage": MessageLookupByLibrary.simpleMessage("कोई समीक्षा नहीं"),
        ...
        "NothingFound": MessageLookupByLibrary.simpleMessage("कुछ भी नहीं मिला"),
        "NothingWasFoundWithEmoji": MessageLookupByLibrary.simpleMessage("कुछ नहीं मिला"),
        ...
        "NotifyTheAudience": MessageLookupByLibrary.simpleMessage("Notify the audience"),
        "NowLetsGetToKnowEachOther": MessageLookupByLibrary.simpleMessage("आइए अब एक-दूसरे को जानें"),
        "NowWeKnowYouBetter": MessageLookupByLibrary.simpleMessage("धन्यवाद!\nअब हम आपको बेहतर जानते हैं"),
        ...
        "OfferPrice": m46,
        "OfferSuccessfullyActivated": MessageLookupByLibrary.simpleMessage("प्रस्ताव सफलतापूर्वक सक्रिय"),
        "Offers": MessageLookupByLibrary.simpleMessage("Offers"),
        "OfficeAppartmentNumber": MessageLookupByLibrary.simpleMessage("कार्यालय या अपार्टमेंट नंबर"),
        ...
        "OnboardingSlide1": MessageLookupByLibrary.simpleMessage("मज़े करने के लिए"),
        "OnboardingSlide2": MessageLookupByLibrary.simpleMessage("व्यापार और अनुसंधान करने के लिए"),
        "OnboardingSlide3": MessageLookupByLibrary.simpleMessage("बस आराम करने के लिए"),
        "Ooops": MessageLookupByLibrary.simpleMessage("उफ़!"),
        "Oops": MessageLookupByLibrary.simpleMessage("Oops"),
        "OopsIWillTryAgain": MessageLookupByLibrary.simpleMessage("उफ़, मैं फिर कोशिश करूँगा"),
        ...
        "OrDragFilesHere": MessageLookupByLibrary.simpleMessage("या फ़ाइलों को यहां खींचें"),
        ...
        "PasswordHint": MessageLookupByLibrary.simpleMessage("अक्षर, संख्या, ! “ @ # \$ % & विचार, 8 अक्षर"),
        "PasswordMustBeAtLeast8Characters": MessageLookupByLibrary.simpleMessage("पासवर्ड कम से कम 8 अक्षर होना चाहिए"),
        "Past": MessageLookupByLibrary.simpleMessage("बीता हुआ"),
        "Paused": MessageLookupByLibrary.simpleMessage("Paused"),
        "Pay": MessageLookupByLibrary.simpleMessage("Pay"),
        "PayForTheBonusOffer": MessageLookupByLibrary.simpleMessage("Pay for the bonus offer"),
        "PayForTheNotification": MessageLookupByLibrary.simpleMessage("Pay for the notification"),
        "Permissions": MessageLookupByLibrary.simpleMessage("अनुमतियाँ"),
        "Personal": MessageLookupByLibrary.simpleMessage("व्यक्तिगत"),
        "PersonalCredentials": MessageLookupByLibrary.simpleMessage("व्यक्तिगत क्रेडेंशियल्स"),
        "PersonalRespect": MessageLookupByLibrary.simpleMessage("व्यक्तिगत सम्मान"),
        "PersonalTop": MessageLookupByLibrary.simpleMessage("व्यक्तिगत शीर्ष"),
        "PersonalizeYourOffer": MessageLookupByLibrary.simpleMessage("Personalize your offer"),
        "PersonalizeYourReminder": MessageLookupByLibrary.simpleMessage("Personalize your reminder"),
        ...
        "PhotoUploadFiles": MessageLookupByLibrary.simpleMessage("फोटो (फाइल अपलोड)"),
        ...
        "PlaceSubmittedSuccessfully": MessageLookupByLibrary.simpleMessage("सफलतापूर्वक प्रस्तुत स्थान"),
        ...
        "PleaseEnterCurrentLimit": MessageLookupByLibrary.simpleMessage("कृपया वर्तमान सीमा दर्ज करें"),
        "PleaseEnterLimit": MessageLookupByLibrary.simpleMessage("कृपया सीमा दर्ज करें"),
        "PleaseEnterValidDescription": MessageLookupByLibrary.simpleMessage("कृपया एक मान्य विवरण दर्ज करें"),
        "PleaseEnterValidTitle": MessageLookupByLibrary.simpleMessage("कृपया एक मान्य शीर्षक दर्ज करें"),
        "PleaseFillOutDate": MessageLookupByLibrary.simpleMessage("कृपया दिनांक भरें"),
        "PleaseFillOutYourWishes": MessageLookupByLibrary.simpleMessage("कृपया अपनी इच्छाएं पूरी करें"),
        "PleaseFillOutYourWishesAndSelectDate":
            MessageLookupByLibrary.simpleMessage("कृपया अपनी इच्छाएं भरें और दिनांक चुनें"),
        "PleaseSelectANiche": MessageLookupByLibrary.simpleMessage("कृपया एक आला चुनें"),
        "PleaseSelectAtLeastNReligion": m46,
        "PleaseSelectAtLeastOneAgeRange": MessageLookupByLibrary.simpleMessage("कृपया कम से कम एक आयु सीमा चुनें"),
        "PleaseSelectAtLeastOnePriceSegment":
            MessageLookupByLibrary.simpleMessage("Please select at least one price segment"),
        "PleaseSelectGender": MessageLookupByLibrary.simpleMessage("कृपया एक लिंग चुनें"),
        "PleaseSelectOneType": MessageLookupByLibrary.simpleMessage("कृपया एक प्रकार चुनें"),
        "PlusXNewChatComments": m47,
        "PlusXNewContests": MessageLookupByLibrary.simpleMessage("+ नई प्रतियोगिता"),
        "PlusXNewInterviews": MessageLookupByLibrary.simpleMessage("+ नई इंटरव्यू"),
        "PlusXNewRespects": m48,
        "PlusXNewReviews": m49,
        "PlusXNewRoutes": MessageLookupByLibrary.simpleMessage("+ नई रूट"),
        "PlusXNewVideoReactions": m50,
        ...
        "PremiumSubscriptionFeature2": MessageLookupByLibrary.simpleMessage("विशेष प्रोफ़ाइल लेबल"),
        "PremiumSubscriptionFeature3": MessageLookupByLibrary.simpleMessage(
            "स्थानों और घटनाओं के बारे में समीक्षा छोड़ने, वीडियो-प्रतिक्रिया देने, रेटिंग में भाग लेने की क्षमता"),
        "PremiumSubscriptionFeature4":
            MessageLookupByLibrary.simpleMessage("पसंदीदा स्थानों को जोड़ने/सुझाव देने की क्षमता"),
        "PremiumSubscriptionFeature5":
            MessageLookupByLibrary.simpleMessage("डार्क/लाइट डिजाइन थीम स्विच करने की क्षमता"),
        "PremiumSubscriptionFeature6": MessageLookupByLibrary.simpleMessage("विशेष अधिकारी लेबल"),
        "PremiumSubscriptionFeature7":
            MessageLookupByLibrary.simpleMessage("Ability to create and share convenient stacks of favorites"),
        "PremiumSubscriptionFeature8": MessageLookupByLibrary.simpleMessage("Have your own event scheduler"),
        ...
        "ProSubscriptionFeature1": MessageLookupByLibrary.simpleMessage("विशेष प्रोफ़ाइल लेबल"),
        "ProSubscriptionFeature2": MessageLookupByLibrary.simpleMessage("विशेष अधिकारी लेबल"),
        "ProSubscriptionFeature3": MessageLookupByLibrary.simpleMessage(
            "स्थानों और घटनाओं के बारे में समीक्षा छोड़ने, वीडियो-प्रतिक्रिया देने, रेटिंग में भाग लेने की क्षमता"),
        "ProSubscriptionFeature4":
            MessageLookupByLibrary.simpleMessage("पसंदीदा स्थानों को जोड़ने/सुझाव देने की क्षमता"),
        "ProSubscriptionFeature5": MessageLookupByLibrary.simpleMessage("डार्क/लाइट डिजाइन थीम स्विच करने की क्षमता"),
        "ProSubscriptionFeature6":
            MessageLookupByLibrary.simpleMessage("आपकी घटनाओं, सांख्यिकी और विश्लेषण की आंतरिक लक्षित प्रचार"),
        "ProSubscriptionFeature7": MessageLookupByLibrary.simpleMessage("विशेष सूचनाओं का उपयोग करने की क्षमता"),
        "ProTools": MessageLookupByLibrary.simpleMessage("Pro tools"),
        "Product": MessageLookupByLibrary.simpleMessage("उत्पाद"),
        "Products": m56,
        "ProfileAskOrSupportHiwHint": m57,
        "ProfileAskOrSupportHiwSubtitle": MessageLookupByLibrary.simpleMessage("अपने या किसी और के"),
        "ProfileAskOrSupportHiwTitle": MessageLookupByLibrary.simpleMessage("अपने सपने को पूरा करें..."),
        "ProfileFindSomeoneHiwHint": m58,
        "ProfileFindSomeoneHiwSubtitle": MessageLookupByLibrary.simpleMessage("किसी को खोजें और उसके साथ जाएं"),
        "ProfileFindSomeoneHiwTitle": MessageLookupByLibrary.simpleMessage("अकेले मत रहो..."),
        ...
        "PushUpYourBusiness": MessageLookupByLibrary.simpleMessage("अपने व्यवसाय को पुश करें"),
        "RangeEndValueIsLessThanBeginingOne":
            MessageLookupByLibrary.simpleMessage("सीमा समाप्ति मान प्रारंभिक मान से कम है"),
        "Rating": MessageLookupByLibrary.simpleMessage("रेटिंग"),
        "Reactions": m59,
        "ReactionsBy": MessageLookupByLibrary.simpleMessage("प्रतिक्रिया\nके द्वारा"),
        "ReactionsByCritics": MessageLookupByLibrary.simpleMessage("निरंकुशों द्वारा प्रतिक्रिया"),
        "Read": m60,
        "RealMoney": MessageLookupByLibrary.simpleMessage("असली पैसे"),
        "RecentlyAdded": MessageLookupByLibrary.simpleMessage("हाल ही में जोड़ा गया"),
        ...
        "RelatedPersonalProperties": MessageLookupByLibrary.simpleMessage("संबंधित व्यक्तिगत गुण"),
        "RelatedProperties": MessageLookupByLibrary.simpleMessage("Related properties"),
        ...
        "RestorePurchase": MessageLookupByLibrary.simpleMessage("खरीदारी को पुनः स्थापित करें"),
        "Reviews": MessageLookupByLibrary.simpleMessage("समीक्षाएं"),
        "ReviewsByCritics": MessageLookupByLibrary.simpleMessage("निरंकुशों द्वारा समीक्षा"),
        "ReviewsCount": m62,
        "ReviewsPosted": m63,
        "ReviewsReceived": m64,
        ...
        "SearchBusinessChooseYourself1": MessageLookupByLibrary.simpleMessage("व्यापारिक क्लब"),
        "SearchBusinessChooseYourself2": MessageLookupByLibrary.simpleMessage("डिजिटल और आईटी सम्मेलन"),
        "SearchBusinessChooseYourself3": MessageLookupByLibrary.simpleMessage("पिच सत्र"),
        "SearchBusinessChooseYourself4": MessageLookupByLibrary.simpleMessage("व्यापारिक खेल"),
        "SearchBusinessChooseYourself5": MessageLookupByLibrary.simpleMessage("फोरम (उद्योग प्रदर्शनी)"),
        "SearchBusinessChooseYourself6": MessageLookupByLibrary.simpleMessage("नेटवर्किंग"),
        "SearchBusinessChooseYourself7": MessageLookupByLibrary.simpleMessage("सेमिनार और प्रशिक्षण"),
        "SearchChooseYourself1": MessageLookupByLibrary.simpleMessage("बच्चों और परिवार के लिए खुशी"),
        "SearchChooseYourself2": MessageLookupByLibrary.simpleMessage("साहस की प्यास"),
        "SearchChooseYourself3": MessageLookupByLibrary.simpleMessage("पार्टियाँ और नृत्य"),
        "SearchChooseYourself4": MessageLookupByLibrary.simpleMessage("अत्यंतता और रोमांच"),
        "SearchChooseYourself5": MessageLookupByLibrary.simpleMessage("ज्ञान और शिक्षा"),
        "SearchChooseYourself6": MessageLookupByLibrary.simpleMessage("बाजार और खरीदारी"),
        "SearchChooseYourself7": MessageLookupByLibrary.simpleMessage("आनंद और शांति"),
        "SearchChooseYourself8": MessageLookupByLibrary.simpleMessage("खेल और खेलने की चीजें"),
        ...
        "SearchHiwHint": m65,
        "SearchHiwSubtitle": MessageLookupByLibrary.simpleMessage("खोजें या दूसरे विकल्प चुनें"),
        "SearchHiwTitle": MessageLookupByLibrary.simpleMessage("सामान्य खोज..."),
        "SearchOrAddTag": MessageLookupByLibrary.simpleMessage("टैग खोजें या जोड़ें"),
        ...
        "SeekingWandererMen": MessageLookupByLibrary.simpleMessage("खोज रहा है वैंडरर"),
        "SeekingWandererWom": MessageLookupByLibrary.simpleMessage("खोज रही है वैंडरर"),
        ...
        "SelectDateRange": MessageLookupByLibrary.simpleMessage("तिथि सीमा चुनें"),
        "SelectDateTime": MessageLookupByLibrary.simpleMessage("Select date and time"),
        ...
        "SelectPeriodOfValid": MessageLookupByLibrary.simpleMessage("Select period of valid"),
        "SelectPriceAndCurrency": MessageLookupByLibrary.simpleMessage("मूल्य और मुद्रा चुनें"),
        "SelectSubs": MessageLookupByLibrary.simpleMessage("Select subs"),
        "SelectType": m66,
        "SelectYourBooking": MessageLookupByLibrary.simpleMessage("अपनी बुकिंग चुनें"),
        "SelectYourFavoriteProduct": MessageLookupByLibrary.simpleMessage("Select your favorite product"),
        "SelectYourReligions": MessageLookupByLibrary.simpleMessage("अपने धर्म चुनें"),
        "SelectYourSpecialty": MessageLookupByLibrary.simpleMessage("Select your specialty"),
        "SelectionOfTheBest": MessageLookupByLibrary.simpleMessage("सर्वश्रेष्ठ का चयन"),
        ...
        "SetWorkHours": MessageLookupByLibrary.simpleMessage("कार्य का समय निर्धारित करें"),
        "Settings": MessageLookupByLibrary.simpleMessage("सेटिंग्स"),
        "Share": MessageLookupByLibrary.simpleMessage("शेयर"),
        "ShareCard": m67,
        "SharedWithYou": MessageLookupByLibrary.simpleMessage("आपके साथ साझा किया गया"),
        "ShowDeleted": MessageLookupByLibrary.simpleMessage("हटाए गए दिखाएं"),
        "ShowInContentCard": MessageLookupByLibrary.simpleMessage("Show in content card"),
        "ShowMore": MessageLookupByLibrary.simpleMessage("अधिक\nदिखाएं"),
        "ShowResult": MessageLookupByLibrary.simpleMessage("परिणाम दिखाओ"),
        "ShowTheBarcode": MessageLookupByLibrary.simpleMessage("भुगतान करते समय चेकआउट पर बारकोड दिखाएं"),
        "ShraziidGoblet": MessageLookupByLibrary.simpleMessage("श्राज़ीद गोब्लेट"),
        "ShraziidGobletDescription":
            MessageLookupByLibrary.simpleMessage("एक प्राचीन गोब्लेट जो रेत के राज्य के महान श्राज़ीद खुद ने पिया था।"),
        "Shuffle": MessageLookupByLibrary.simpleMessage("मिश्रण"),
        "ShuffleExchangeSystem": MessageLookupByLibrary.simpleMessage("...Shuffle एक्सचेंज सिस्टम"),
        "ShuffleHiwHint": m68,
        "ShuffleHiwSubtitle": MessageLookupByLibrary.simpleMessage("व्यक्तिगत स्थान खोजें"),
        "ShuffleHiwTitle": MessageLookupByLibrary.simpleMessage("शफल..."),
        "ShuffleWithRightWhitespace": MessageLookupByLibrary.simpleMessage("मिश्रण"),
        ...
        "SmartLeisureSelection": MessageLookupByLibrary.simpleMessage("हर जगह, हर किसी के लिए स्मार्ट अवकाश चयन।"),
        "SocialSubtitle": MessageLookupByLibrary.simpleMessage("उपयोगी सेवाएँ और स्थान"),
        ...
        "SpinnerHiwHint": m70,
        "SpinnerHiwSubtitle": MessageLookupByLibrary.simpleMessage("आपको व्यक्तिगत घटनाएँ मिलती हैं"),
        "SpinnerHiwTitle": MessageLookupByLibrary.simpleMessage("आप इसे घुमाते हैं..."),
        "SpinnerTitle": MessageLookupByLibrary.simpleMessage("घटनाएँ जिन्हें आप नहीं चाहते हैं छोड़ना"),
        "StacksAndSomethingElseAreAvailableForYou":
            MessageLookupByLibrary.simpleMessage("स्टैक्स और कुछ और आपके लिए उपलब्ध हैं..."),
        "StacksAreOn": MessageLookupByLibrary.simpleMessage("स्टैक्स चालू हैं"),
        "StacksShares": m71,
        "StartBookingCreation": MessageLookupByLibrary.simpleMessage("बुकिंग निर्माण शुरू करें"),
        "StartToExplore": MessageLookupByLibrary.simpleMessage("अन्वेषण करना प्रारंभ करें"),
        ...
        "SuccessfullyAnswered": MessageLookupByLibrary.simpleMessage("सफलतापूर्वक उत्तर दिया"),
        ...
        "SupportPeopleAroundYou": MessageLookupByLibrary.simpleMessage("अपने आसपास के लोगों का समर्थन करें"),
        "SupportedFormatsBooking": MessageLookupByLibrary.simpleMessage(
            "Supported formats: JPEG/JPG/PNG.\nMax size - 10 MB.\nMax resolution - 3840 x 2200 px"),
        "SureYouWantToExit": MessageLookupByLibrary.simpleMessage("क्या आप निकलना चाहते हैं?"),
        "SwipeToStart": MessageLookupByLibrary.simpleMessage("शुरू करने के लिए स्वाइप करें"),
        "SwitchAnyTime":
            MessageLookupByLibrary.simpleMessage("आप इसे अपनी प्रोफ़ाइल सेटिंग्स में किसी भी समय स्विच कर सकते हैं"),
        "Tags": MessageLookupByLibrary.simpleMessage("टैग"),
        "TapIt": MessageLookupByLibrary.simpleMessage("इसे टैप करें"),
        "TapOnceToChoose": MessageLookupByLibrary.simpleMessage("चुनने के लिए एक बार टैप करें"),
        "TapToSeeMore": MessageLookupByLibrary.simpleMessage("अधिक देखने के लिए टैप करें"),
        "TapToSetAddress": MessageLookupByLibrary.simpleMessage("पता सेट करने के लिए टैप करें"),
        "TapTwiceToMarkYourFavorites":
            MessageLookupByLibrary.simpleMessage("अपने पसंदीदा को चिह्नित करने के लिए दो बार टैप करें।"),
        ...
        "TheBestParties": MessageLookupByLibrary.simpleMessage("सबसे अच्छी पार्टियां"),
        "TheBestTechConf": MessageLookupByLibrary.simpleMessage("सर्वश्रेष्ठ तकनीकी सम्मेलन"),
        "TheBestTechListSuccessfullyAdded":
            MessageLookupByLibrary.simpleMessage("सूची\" सर्वश्रेष्ठ टेक्नोलॉजीज कॉन्फ \" सफलतापूर्वक जोड़ा गया"),
        "TheBestTechnologiesConf": MessageLookupByLibrary.simpleMessage("सर्वश्रेष्ठ प्रौद्योगिकी सम्मेलन"),
        "TheMoreInfoWeAboutYouGetTheBetter":
            MessageLookupByLibrary.simpleMessage("हमें आपके बारे में जितनी अधिक जानकारी मिलेगी, उतना बेहतर होगा"),
        "TheMoreInfoWeGetTheBetter":
            MessageLookupByLibrary.simpleMessage("हमें जितनी अधिक जानकारी मिलेगी, उतना बेहतर होगा"),
        ...
        "ThroughANonAggregatorSystem":
            MessageLookupByLibrary.simpleMessage("एक गैर के माध्यम से-\nएग्रीगेटर प्रणाली\nविशेष रूप से आप के लिए"),
        ...
        "TitleYourTop": MessageLookupByLibrary.simpleMessage("अपने शीर्ष का शीर्षक दें"),
        "ToAccessAll": MessageLookupByLibrary.simpleMessage("सभी तक पहुँचने के लिए"),
        ...
        "ToBecomeAnInfluencerYouNeedToDo":
            MessageLookupByLibrary.simpleMessage("To become an influencer you need to do"),
        ...
        "ToOpenTheNextSetOfToolsYouNeedToDo":
            MessageLookupByLibrary.simpleMessage("अगले टूल सेट को खोलने के लिए आपको यह करना होगा"),
        ...
        "TopEventsFor": m75,
        "TopNDonatorsReceiveXPoints": m76,
        "TopPlacesRatedBy": m77,
        ...
        "TypeOfContent": MessageLookupByLibrary.simpleMessage("सामग्री का प्रकार"),
        "Undefined": MessageLookupByLibrary.simpleMessage("अपरिभाषित"),
        "UnderDevelopmentMessage": MessageLookupByLibrary.simpleMessage("विकास के अधीन"),
        "UnderService": MessageLookupByLibrary.simpleMessage("विकल्प चुनें"),
        "Unfollow": MessageLookupByLibrary.simpleMessage("अनफॉलो"),
        "UniqueProperties": MessageLookupByLibrary.simpleMessage("अद्वितीय गुण"),
        "UniqueStatistics": MessageLookupByLibrary.simpleMessage("अद्वितीय आंकड़े"),
        "UnknownRing": MessageLookupByLibrary.simpleMessage("अज्ञात रिंग"),
        "UnknownRingDescription":
            MessageLookupByLibrary.simpleMessage("अजीब रिंग। हमें यह नहीं पता क्यों यह यहाँ है..."),
        "Unread": MessageLookupByLibrary.simpleMessage("अपठित"),
        "UnsubscribeFromProfile": MessageLookupByLibrary.simpleMessage("अनफॉलो"),
        "Upcoming": MessageLookupByLibrary.simpleMessage("आगामी"),
        "UpcomingEvent": MessageLookupByLibrary.simpleMessage("आगामी कार्यक्रम"),
        "UpcomingGlobalEvents": MessageLookupByLibrary.simpleMessage("आगामी वैश्विक घटनाएँ"),
        ...
        "UpdateAppMessageTitle": MessageLookupByLibrary.simpleMessage("अद्यतन का समय"),
        "UpgradeAccount": m78,
        "UpgradeAccountConfirmation": MessageLookupByLibrary.simpleMessage("अपग्रेड"),
        "UpgradeForNmoney": m79,
        "UploadingVideo": MessageLookupByLibrary.simpleMessage("वीडियो अपलोड कर रहा है"),
        "Upsales": MessageLookupByLibrary.simpleMessage("अपसेल्स"),
        "UpsalesAvailable": MessageLookupByLibrary.simpleMessage("अपसेल्स उपलब्ध हैं"),
        "UpsalesAvailableHint": MessageLookupByLibrary.simpleMessage("टी-शर्ट, टोपी, योगा चटाई, मग"),
        "UpsalesProductsFrom": m80,
        "User": MessageLookupByLibrary.simpleMessage("उपयोगकर्ता"),
        "UserHasNoPublicProfileEnd": MessageLookupByLibrary.simpleMessage("का सार्वजनिक प्रोफ़ाइल नहीं है"),
        "UserHasNoPublicProfileStart": MessageLookupByLibrary.simpleMessage("उपयोगकर्ता"),
        "UserTypeSelectionPrompt":
            MessageLookupByLibrary.simpleMessage("आपके द्वारा बनाने जा रहे खाते का प्रकार चुनें"),
        "Users": m81,
        "UsingHealthKit": MessageLookupByLibrary.simpleMessage("हेल्थकिट का उपयोग करना"),
        "UsingNotifications": MessageLookupByLibrary.simpleMessage("सूचनाएँ उपयोग करें"),
        "ValueMustBeAtLeast3Characters": MessageLookupByLibrary.simpleMessage("मान कम से कम 3 वर्ण लंबा होना चाहिए"),
        "VeryOften": MessageLookupByLibrary.simpleMessage("बहुत अक्सर"),
        "Video": MessageLookupByLibrary.simpleMessage("वीडियो"),
        "VideoFileNotCut": MessageLookupByLibrary.simpleMessage("वीडियो फ़ाइल को काटा नहीं जा सका"),
        "VideoReactionAdded": MessageLookupByLibrary.simpleMessage("आपकी प्रतिक्रिया सफलतापूर्वक जोड़ी गई है"),
        "VideoReactionUploadedMessage": MessageLookupByLibrary.simpleMessage("प्रतिक्रिया सफलतापूर्वक जोड़ी गई"),
        "VideoReactions": MessageLookupByLibrary.simpleMessage("वीडियो प्रतिक्रियाएँ"),
        "VideoUploadFiles": MessageLookupByLibrary.simpleMessage("वीडियो (फ़ाइलें अपलोड करें)"),
        ...
        "VisitFirstToOpenNext": MessageLookupByLibrary.simpleMessage("अगला खोलने के लिए पहले जाएँ"),
        ...
        "WeHavePlacesJustForYou": MessageLookupByLibrary.simpleMessage("हमारे पास सिर्फ आपके लिए जगहें हैं"),
        "WeWillLetKnowResults": MessageLookupByLibrary.simpleMessage("हम आपको नतीजे बताएंगे"),
        ...
        "WhyDoYouLoveIt": MessageLookupByLibrary.simpleMessage("आप इसे क्यों प्यार करते हैं ?"),
        "WillBe": MessageLookupByLibrary.simpleMessage(" होगा।"),
        "WillBeImplementedSoon": MessageLookupByLibrary.simpleMessage("जल्द ही लागू किया जाएगा"),
        "WiseacreLadyOfSands": MessageLookupByLibrary.simpleMessage("बालू की महिला बुद्धिमान"),
        "WiseacreOfSands": MessageLookupByLibrary.simpleMessage("बालू का बुद्धिमान"),
        "WithInDays": m82,
        "WithYourPreferences": MessageLookupByLibrary.simpleMessage("आपका\nप्राथमिकताएं के साथ"),
        ...
        "WrongSecurityCode": MessageLookupByLibrary.simpleMessage("गलत सुरक्षा कोड"),
        "XCouldNotBeEmpty": m83,
        "XInvitesY": m84,
        "XIsRequired": m85,
        "XSuccessfullyUpdated": m86,
        "XYearsPlus": m87,
        ...
        "YouBetterCheckThisOut": MessageLookupByLibrary.simpleMessage("बेहतर होगा कि आप इसकी जांच कर लें"),
        "YouCanGet": MessageLookupByLibrary.simpleMessage("आप प्राप्त कर सकते हैं"),
        "YouCanSeeYourXPromotionMenu": m93,
        "YouCanStillRequestRefundYourComplaint":
            MessageLookupByLibrary.simpleMessage("आप अपनी शिकायत पर वापसी का अनुरोध कर सकते हैं"),
        "YouGetAccessToTrial": MessageLookupByLibrary.simpleMessage("आपको सभी लाभ मुफ्त में मिलते हैं"),
        "YouGetExactlyWhatYouNeed": MessageLookupByLibrary.simpleMessage("आपको वही मिलता है जो आपको चाहि"),
        "YouMissedALot": MessageLookupByLibrary.simpleMessage("आपने बहुत कुछ छोड़ दिया"),
        ...
        "YouWillReceiveNewTools": MessageLookupByLibrary.simpleMessage("आपको नए उपकरण मिलेंगे"),
        "YoullFindIt": MessageLookupByLibrary.simpleMessage("आप उसे खोज लोगे"),
        "YourAge": MessageLookupByLibrary.simpleMessage("आपकी उम्र"),
        "YourAudienceAge": MessageLookupByLibrary.simpleMessage("आपके दर्शकों की उम्र"),
        "YourClaimHasBeenSent": MessageLookupByLibrary.simpleMessage("आपका दावा भेज दिया गया है"),
        "YourEmail": MessageLookupByLibrary.simpleMessage("आपका ईमेल"),
        "YourEvent": MessageLookupByLibrary.simpleMessage("Your event"),
        "YourLeisureSelection": MessageLookupByLibrary.simpleMessage("आपका अवकाश चयन"),
        ...
        "YourOfferHasAlreadyBeenPublishedToYourAudience": MessageLookupByLibrary.simpleMessage(
        ...
        "YourPriceSegment": MessageLookupByLibrary.simpleMessage("Your price segment"),
        "YourProgress": MessageLookupByLibrary.simpleMessage("Your progress"),
        "YourReminderIsShown1Time":
            MessageLookupByLibrary.simpleMessage("Your reminder is shown 1 time on the specified date."),
