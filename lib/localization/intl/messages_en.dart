...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(amountOfPeople) => "NEXT ${amountOfPeople} PEOPLE";

  static String m4(religionCount) =>
      "Please select at least ${religionCount} religion";

  static String m5(separator) => "Tell us more${separator}about yourself";

  static String m6(amountOfTopDonators, multiplier) =>
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "DontBeAlone":
            MessageLookupByLibrary.simpleMessage("Don\\\'t be alone"),
        ...
        "PleaseSelectAtLeastNReligion": m4,
        "PleaseSelectGender":
