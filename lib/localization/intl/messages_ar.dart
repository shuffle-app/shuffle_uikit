...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(actuallyRaised, goal) => "raised ${actuallyRaised}/\$${goal}\$";

  static String m16(editingType) => "${editingType} place";

  static String m17(inputType) => "Enter ${inputType}";
  ...
  static String m28(formattedPrice) => "For ${formattedPrice}";

  static String m29(from, to) =>
      "${from} - ${to} ${Intl.plural(from, zero: 'y.o.', one: 'y.o.', two: 'y.o.', few: 'y.o.', many: 'y.o.', other: 'y.o.')}";

  static String m30(helpfulCount) => "Helpful ${helpfulCount}";
  ...
  static String m32(hours) => "${hours}h ago";
  ...
  static String m38(provider) => "Continue with ${provider}";
  ...
  static String m41(minutes) => "${minutes}m ago";

  static String m42(placeIndex) => "${placeIndex} place";

  static String m43(elements) => "Next ${elements}";

  static String m44(amountOfPeople) => "Next ${amountOfPeople} people";
