...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(progress) => "Compressing video ${progress}%";
  ...
  static String m12(editingType) => "${editingType} place";

  static String m13(inputType) => "Enter ${inputType}";
  ...
  static String m23(formattedPrice) => "For ${formattedPrice}";

  static String m24(helpfulCount) => "Helpful ${helpfulCount}";

  static String m25(days) =>
  ...
  static String m26(hours) => "${hours}h ago";
  ...
  static String m29(provider) => "Continue with ${provider}";

  static String m30(item) =>
      "${Intl.plural(item, zero: 'Members', one: 'Member', two: 'Members', few: 'Members', other: 'Members')}";

  static String m31(minutes) => "${minutes}m ago";

  static String m32(placeIndex) => "${placeIndex} place";

  static String m33(elements) => "Next ${elements}";

  static String m34(amountOfPeople) => "Next ${amountOfPeople} people";
  ...
  static String m41(amount) => "Read ${amount}";
  ...
  static String m46(type) => "select ${type}";
  ...
  static String m51(separator) => "Tell us more${separator}about yourself";

  static String m52(amountOfTopDonators, multiplier) =>
      "Top ${amountOfTopDonators} donators receive x${multiplier} points";

  static String m53(separator) => "Top places rated${separator}by";

  static String m54(type) => "To use this function plz upgrade to ${type}";

  static String m55(forNMoney) => "Upgrade ${forNMoney}";
  ...
  static String m58(value) => "${value} could not be empty";

  static String m59(title) => "${title} is required";

  static String m60(value) => "${value} successfully updated";
