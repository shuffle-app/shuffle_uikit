...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(x) => "Добавь хотя бы одно ${x} для его продвижения";

  static String m1(value) => "Все ${value} фичи доступны!";

  static String m2(allowValue) => "Использовать ${allowValue}";

  static String m3(allowedCharacters) =>
      "Допустимые символы ${allowedCharacters}";

  static String m4(x) => "Вы уверены что хотите заархивировать ${x}?";

  static String m5(x) => "Букинг (+${x})";
  ...
  static String m8(sum, currency) => "Бюджет ${sum}${currency}";
  ...
  static String m10(creationDate, deletionDate) =>
  ...
  static String m12(x) => "Город автоматически определяется как ${x}.";
  ...
  static String m14(progress) => "Сжатие видео ${progress}%";

  static String m15(x) => "Подтверди или отредактируй ${x}";
  ...
  static String m18(count) => "${count} Отзывов";

  static String m19(count) => "${count} Видео-Реакций";

  static String m20(x) =>
      "Создай рекламную акцию для твоего ${x} и увеличь посещаемость";

  static String m21(count) => "Создай УТП за \$${count}";

  static String m22(x, y) =>
      "Создай новое ${x} для своего ${y} и увеличь посещаемость";

  static String m23(days) =>
      "${Intl.plural(days, zero: 'дней', one: 'день', two: 'дня', few: 'дня', many: 'дней', other: 'дней')}";

  static String m24(count) =>
      "${count} ${Intl.plural(count, zero: 'дней', one: 'день', two: 'дня', few: 'дня', many: 'дней', other: 'дней')} назад";

  static String m25(x) => "Вы уверены что хотите удалить ${x} навсегда?";

  static String m26(actuallyRaised, goal) =>
      "собрано ${actuallyRaised}/\$${goal}\$";

  static String m27(editingType) => "${editingType} место";

  static String m28(inputType) => "Ввести ${inputType}";

  static String m29(title) => "Введи ${title}";

  static String m30(x) => "Не удалось подключиться к ${x}";
  ...
  static String m41(formattedPrice) => "За ${formattedPrice}";

  static String m42(count) => "Сейчас бесплатно, позже ${count}\$";

  static String m43(from, to) =>
      "${from} - ${to} ${Intl.plural(from, zero: 'лет', one: 'год', two: 'года', few: 'года', many: 'лет', other: 'лет')}";

  static String m44(helpfulCount) => "Полезно ${helpfulCount}";
  ...
  static String m46(hours) => "${hours}ч назад";

  static String m47(count) =>
      "${count} ${Intl.plural(count, zero: 'часов', one: 'час', two: 'часа', few: 'часов', many: 'часов', other: 'часов')} назад";
  ...
  static String m49(invitedPeopleCount) =>
  ...
  static String m50(invitedPeopleCount) =>
  ...
  static String m51(x) => "Менее ${x}%";

  static String m52(x) => "Более ${x}%";
  ...
  static String m55(provider) => "Продолжить с ${provider}";
  ...
  static String m58(minutes) => "${minutes}м назад";

  static String m59(count) =>
      "${count} ${Intl.plural(count, zero: 'месяцев', one: 'месяц', two: 'месяца', few: 'месяца', many: 'месяцев', other: 'месяцев')} назад";

  static String m60(placeIndex) => "${placeIndex} место";

  static String m61(elements) => "Ещё ${elements}";

  static String m62(amountOfPeople) => "Следующие ${amountOfPeople}";

  static String m63(count) => "Цена оффера ${count}\$";
  ...
  static String m83(amount) => "Читать ${amount}";

  static String m84(message) => "Ответ на ${message}";
  ...
  static String m93(x) => "Показать ${x} в профиле";

  static String m94(item) =>
  ...
  static String m98(x) => "Статус: ${x} - Доступно";

  static String m99(x) =>
      "Статус ${x} - Доступ ограничен или страница не найдена";

  static String m100(separator) => "Расскажи${separator}о себе";
  ...
  static String m103(x) => "Сегодняшняя сводка: ${x}";

  static String m104(date) => "Топ событий на ${date}";

  static String m105(amountOfTopDonators, multiplier) =>
      "Топовые ${amountOfTopDonators} донаторы получают x${multiplier} поинтов";

  static String m106(separator) => "Топовый контент${separator}от";

  static String m107(x) => "Вы отправляете ${x} на модерацию";

  static String m108(type) => "Чтобы пользоваться этим нужен ${type} аккаунт";

  static String m109(forNMoney) => "Купить ${forNMoney}";
  ...
  static String m112(count) =>
      "${count} ${Intl.plural(count, zero: 'неделей', one: 'неделя', two: 'недели', few: 'недели', many: 'недель', other: 'недели')} назад";

  static String m113(days) =>
      "через ${days} ${Intl.plural(days, zero: 'дней', one: 'день', two: 'дня', few: 'дня', many: 'дней', other: 'дней')}";

  static String m114(value) => "${value} не может быть пустым";

  static String m115(x) => "${x} День";

  static String m116(x) => "${x} Час";
  ...
  static String m120(x) => "${x} успешно созданно";

  static String m121(value) => "${value} успешно обновлено";

  static String m122(x) => "${x} Неделя";

  static String m123(years) =>
      "${years}+ ${Intl.plural(years, zero: 'лет', one: 'год', two: 'года', few: 'года', many: 'лет', other: 'лет')}";

  static String m124(count) =>
      "${count} ${Intl.plural(count, zero: 'лет', one: 'год', two: 'года', few: 'лет', many: 'лет', other: 'лет')} назад";

  static String m125(years) =>
      "${years} ${Intl.plural(years, zero: 'лет', one: 'год', two: 'года', few: 'года', many: 'лет', other: 'лет')}";

  static String m126(x) => "Ты можешь увидеть своё ${x} в меню акции";

  static String m127(amountOfInvitedPersons) =>
      "Вы отправили приглашение ${amountOfInvitedPersons} людям";

  static String m128(name) => "Уверены, что хотите удалить ${name}?";

  static String m129(name) =>
      "Ты больше не сможешь отправлять сообщения ${name}";

  static String m130(x) =>
      "Уведомление о начале мероприятия будет показано ${x} раза: за неделю, за день и за час до начала";

  static String m131(x) => "через ${x} дня";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "AcceptDonations": MessageLookupByLibrary.simpleMessage(
      "Принимать донаты или помогать другим исполнить мечты",
    ),
    "AcceptPayments": MessageLookupByLibrary.simpleMessage("Принимай оплату"),
    ...
    "AddFeedbackFieldHint": MessageLookupByLibrary.simpleMessage(
      "Расскажи, что понравилось или запомнилось",
    ),
    ...
    "AddTitle": MessageLookupByLibrary.simpleMessage("Добавь заголовок"),
    ...
    "AddToScheduler": MessageLookupByLibrary.simpleMessage("В план"),
    ...
    "AreYouSureYouWantToDeleteThisVoice": MessageLookupByLibrary.simpleMessage(
      "Точно хочешь удалить этот войс?",
    ),
    ...
    "AtEntranceCash": MessageLookupByLibrary.simpleMessage(
      "При входе, наличные",
    ),
    "AtTheEntrance": MessageLookupByLibrary.simpleMessage("у входа"),
    "Atheism": MessageLookupByLibrary.simpleMessage("Атеизм"),
    "Athlete": MessageLookupByLibrary.simpleMessage("Спортсмен"),
    "Audience": MessageLookupByLibrary.simpleMessage("Аудитория"),
    "AudienceDefinition": MessageLookupByLibrary.simpleMessage(
    ...
    "AwaitingPayment": MessageLookupByLibrary.simpleMessage("Ожидает оплаты"),
    ...
    "BasedOnYourActivityWeDetermineYourCondition":
        MessageLookupByLibrary.simpleMessage(
          "На основании твоей активности, пульса и других факторов мы определяем состояние и стараемся рекомендовать то, что нужно конкретно тебе прямо сейчас",
        ),
    ...
    "BecomePro": MessageLookupByLibrary.simpleMessage("Стать Pro"),
    ...
    "BookingPlural": MessageLookupByLibrary.simpleMessage("Букинги"),
    "BookingPopUpText": MessageLookupByLibrary.simpleMessage(
      "Show up ratio учитывает, как давно пользователь был онлайн, включены ли у него уведомления и процент неявок",
    ),
    "Bookings": m7,
    ...
    "BookingsForYourEvent": MessageLookupByLibrary.simpleMessage(
      "Букинги на твое событие",
    ),
    "BookingsHeading": MessageLookupByLibrary.simpleMessage("Брони"),
    "BookingsPromo": MessageLookupByLibrary.simpleMessage("Бронирование"),
    ...
    "ByDefaultYourOfferWillDisplay": MessageLookupByLibrary.simpleMessage(
      "По умолчанию в оффере будет изображение из загруженных фото",
    ),
    "ByDefaultYourReminderWillDisplay": MessageLookupByLibrary.simpleMessage(
      "По умолчанию, в твоём напоминании будет изображение из загруженных фото",
    ),
    ...
    "CannotFindThisNews": MessageLookupByLibrary.simpleMessage(
    ...
    "CardOpening": m9,
    "CardViewsWithinAPromotion": MessageLookupByLibrary.simpleMessage(
      "Просмотры карточек в промо",
    ),
    ...
    "CityXWasDetected": m12,
    "ClickEnterToSearch": MessageLookupByLibrary.simpleMessage(
      "Нажми Ввод для поиска",
    ),
    "Clicks": MessageLookupByLibrary.simpleMessage("Клики"),
    "ClicksOnTheCardWithinAPromotion": MessageLookupByLibrary.simpleMessage(
    ...
    "CompanyPosition": MessageLookupByLibrary.simpleMessage("Должность"),
    "CompanyPresentationSlider1": MessageLookupByLibrary.simpleMessage(
      "Это закрытый профиль, который позволяет публиковать места, филиалы и события",
    ),
    "CompanyPresentationSlider2": MessageLookupByLibrary.simpleMessage(
      "Ты можешь создавать филиалы; в карточке места пользователи увидят всю сеть",
    ),
    "CompanyPresentationSlider3": MessageLookupByLibrary.simpleMessage(
      "Твой контент появляется в ротации и рекомендуется через уникальную систему Shuffle, - через свойства юзеров и контента, факторы поведения, гео, погоду и тд",
    ),
    "CompanyPresentationSlider4": MessageLookupByLibrary.simpleMessage(
      "Повысь узнаваемость и посещаемость мест и событий. Всё выстроено вокруг твоих карточек контента",
    ),
    "CompanyPresentationSlider5": MessageLookupByLibrary.simpleMessage(
      "Ты привлекаешь инфлюенсеров-экспертов Shuffle, которые повысят статус твоих мест",
    ),
    "CompanyPresentationSlider6": MessageLookupByLibrary.simpleMessage(
      "Ты можешь взаимодействовать с аудиторией через уникальный функционал специальных уведомлений, напоминаний, предложений и апселлов",
    ),
    "CompanyPresentationSlider7": MessageLookupByLibrary.simpleMessage(
      "Ты можешь использовать внутреннюю систему таргетированной рекламы",
    ),
    "CompanyPresentationSlider8": MessageLookupByLibrary.simpleMessage(
      "Ты можешь интегрировать свою систему бронирования или использовать систему Shuffle в будущем",
    ),
    ...
    "ContentQualityNotice": MessageLookupByLibrary.simpleMessage(
      "Контент будет проходить модерацию, позаботься о его качестве",
    ),
    "ContentThatIsAvailableForYouToViewWillAppearHere":
        MessageLookupByLibrary.simpleMessage(
          "Доступный контент появится здесь",
        ),
    ...
    "CreateAudienceOrSelectOne": MessageLookupByLibrary.simpleMessage(
      "Создай аудиторию или выбери сохраненную",
    ),
    ...
    "DateRangeTime": MessageLookupByLibrary.simpleMessage(
      "Диапазон дат – Время",
    ),
    "DateTime": MessageLookupByLibrary.simpleMessage("Дата – Время"),
    ...
    "DeletePromotion": MessageLookupByLibrary.simpleMessage("Удалить промо"),
    ...
    "EditPromotion": MessageLookupByLibrary.simpleMessage(
      "Редактировать промо",
    ),
    "EditingTypePlace": m27,
    ...
    "EmptyChallengeHardcode": MessageLookupByLibrary.simpleMessage("Хардкор"),
    ...
    "Ending": MessageLookupByLibrary.simpleMessage("Конец"),
    "EnterExternalLink": MessageLookupByLibrary.simpleMessage(
      "Добавить внешнюю ссылку",
    ),
    "EnterInputType": m28,
    "EnterLocation": MessageLookupByLibrary.simpleMessage("Введи локацию"),
    ...
    "EnterTitle": MessageLookupByLibrary.simpleMessage("Введи название"),
    "EnterX": m29,
    ...
    "FeedFavoritesHiwItems": m32,
    "FeedFeelingsHiwItems": m33,
    ...
    "FindSomeoneCardPoints": m38,
    "FindSomeoneCardSameInterests": m39,
    ...
    "HintNumberEventsForPro": MessageLookupByLibrary.simpleMessage(
      "Доступно 3 события & добавь больше за отдельную цену",
    ),
    "HintStripe": MessageLookupByLibrary.simpleMessage(
      "Чтобы воспользоваться, создай аккаунт Stripe в Настройках «Кошелек»",
    ),
    ...
    "HowManyPeopleRegisteredInTheAppWillPotentiallySeeThePost":
        MessageLookupByLibrary.simpleMessage(
          "Сколько людей в приложении потенциально увидят пост",
        ),
    ...
    "IfYouApplyThePromotion": MessageLookupByLibrary.simpleMessage(
      "если воспользуешься промо",
    ),
    "InCash": MessageLookupByLibrary.simpleMessage("наличными"),
    ...
    "InstructionsToEnableHealthKit": MessageLookupByLibrary.simpleMessage(
      "Чтобы включить кит здоровья, перейди в «Конфиденциальность и безопасность» в настройках, затем в «Здоровье» и выбери там «Shuffle app»",
    ),
    ...
    "KeepItUp": MessageLookupByLibrary.simpleMessage(
      "Так держать! Используй инструменты, чтобы улучшить его еще",
    ),
    ...
    "MakeSureYouAreCloseToMakeCheckIn": MessageLookupByLibrary.simpleMessage(
      "Убедись, что ты рядом и попробуй ещё раз",
    ),
    ...
    "MinAgoX": MessageLookupByLibrary.simpleMessage("мин назад"),
    "MinutesAgo": m58,
    ...
    "MustSelectVideo": MessageLookupByLibrary.simpleMessage(
      "Нужно выбрать хотя бы одно видео",
    ),
    "MustVisitTechnologyConf": MessageLookupByLibrary.simpleMessage(
      "Обязательно посети технологическую конференцию",
    ),
    ...
    "NeedAction": MessageLookupByLibrary.simpleMessage("Требуется действие"),
    ...
    "NeedToChargeMoneyForEntry": MessageLookupByLibrary.simpleMessage(
      "Необходимо взять деньги за вход",
    ),
    ...
    "NoFeedbacksYet": MessageLookupByLibrary.simpleMessage(
      "Посещай места и события в Shuffle и делись впечатлениями",
    ),
    ...
    "NoShowsRatioTakesIntoAccount": MessageLookupByLibrary.simpleMessage(
      "Показатель No shows учитывает коэффициенты неявки по всем пользователям",
    ),
    "NoThx": MessageLookupByLibrary.simpleMessage("Нет, спс"),
    "NoVideoReactionsYet": MessageLookupByLibrary.simpleMessage(
      "Посещай места и события в Shuffle и делись видео-реакциями",
    ),
    ...
    "NotStarted": MessageLookupByLibrary.simpleMessage("Не начато"),
    ...
    "NumberOfParticipantsInTheInvitationList":
        MessageLookupByLibrary.simpleMessage(
          "Количество участников в списке приглашенных",
        ),
    ...
    "OfferInfo": MessageLookupByLibrary.simpleMessage("Инфо об оффере"),
    "OfferPrice": m63,
    ...
    "PausePromotion": MessageLookupByLibrary.simpleMessage(
      "Приостановить промо",
    ),
    ...
    "PlaceCompanyInfo": MessageLookupByLibrary.simpleMessage(
      "В случае остановки подписки, твой контент будет удален из ротации до возобновления подписки",
    ),
    ...
    "PleaseAddPhoto": MessageLookupByLibrary.simpleMessage("Добавь фото"),
    "PleaseEnterABranchTitle": MessageLookupByLibrary.simpleMessage(
      "Введи название сети",
    ),
    "PleaseEnterAMessageForTheNews": MessageLookupByLibrary.simpleMessage(
      "Введи сообщение для новости",
    ),
    "PleaseEnterCurrentLimit": MessageLookupByLibrary.simpleMessage(
      "Введи допустимый лимит",
    ),
    "PleaseEnterLimit": MessageLookupByLibrary.simpleMessage("Добавь лимит"),
    ...
    "PleaseSelectAtLeastNReligion": m66,
    ...
    "PleaseValidateXDetailsBeforeModeration": m67,
    "PlusXNewChatComments": m68,
    ...
    "PotentialCoverageOfXPeople": m78,
    ...
    "PremiumSubscriptionFeature1": MessageLookupByLibrary.simpleMessage(
      "Уникальная функция “Коннекты”. Поиск, общение, встречи, нетворкинг",
    ),
    ...
    "PrivateChatApply": MessageLookupByLibrary.simpleMessage(
      "Приватный чат. Подай заявку, нажав",
    ),
    ...
    "ProSubscriptionFeature2": MessageLookupByLibrary.simpleMessage(
      "Возможность создавать свои события",
    ),
    ...
    "ProSubscriptionFeature6": MessageLookupByLibrary.simpleMessage(
      "Внутренняя таргетированная реклама событий, статистика и аналитика",
    ),
    ...
    "Products": m79,
    "ProfileAskOrSupportHiwHint": m80,
    ...
    "PromotionEvaluation": MessageLookupByLibrary.simpleMessage(
      "Оценка\nпродвижения",
    ),
    "PromotionLaunchResults": MessageLookupByLibrary.simpleMessage(
      "Результаты запуска промо",
    ),
    ...
    "RegistrationStripeExplanation": MessageLookupByLibrary.simpleMessage(
      "Можешь использовать платные функции и принимать платежи после регистрации в Stripe",
    ),
    ...
    "Scheduler": MessageLookupByLibrary.simpleMessage("Планер"),
    ...
    "SearchOrAddTag": MessageLookupByLibrary.simpleMessage(
      "Искать или добавить тег",
    ),
    "SearchProperty": MessageLookupByLibrary.simpleMessage("Поиск свойств"),
    "SecAgoX": MessageLookupByLibrary.simpleMessage("сек назад"),
    ...
    "SelectGender": MessageLookupByLibrary.simpleMessage("Выбери пол"),
    ...
    "SelectSubs": MessageLookupByLibrary.simpleMessage("Выбери сабы"),
    ...
    "SelectTitle": MessageLookupByLibrary.simpleMessage("Выбери заголовок"),
    ...
    "SexualContent": MessageLookupByLibrary.simpleMessage("Секс контент"),
    "Share": MessageLookupByLibrary.simpleMessage("Поделиться"),
    "ShareCard": m92,
    "SharedWithYou": MessageLookupByLibrary.simpleMessage("поделилась с вами"),
    "ShockingContent": MessageLookupByLibrary.simpleMessage("Шок контент"),
    ...
    "SpentOnPromotionToday": MessageLookupByLibrary.simpleMessage(
      "Потрачено на промо сегодня",
    ),
    "SpinnerHiwHint": m96,
    ...
    "StacksAndSomethingElseAreAvailableForYou":
        MessageLookupByLibrary.simpleMessage(
          "Для тебя доступны стопки и кое-что еще...",
        ),
    ...
    "StatusXAvailable": m98,
    "StatusXIsNotAvailable": m99,
    ...
    "TextForTheDay": MessageLookupByLibrary.simpleMessage("Текст за день"),
    "TextForTheWeek": MessageLookupByLibrary.simpleMessage("Текст за неделю"),
    "TextInAnHour": MessageLookupByLibrary.simpleMessage("Текст за час"),
    ...
    "TheOfferWillBeAddedToPersonal": MessageLookupByLibrary.simpleMessage(
      "Оффер будет добавлен в личный профиль юзеров, которые смотрят ваш контент или букируют",
    ),
    ...
    "TheTicketCanOnlyBePaidAtTheEntrance": MessageLookupByLibrary.simpleMessage(
      "Билет можно оплатить только на входе",
    ),
    "TheTicketCanOnlyBePaidForUsingThe": MessageLookupByLibrary.simpleMessage(
      "Билет может быть оплачен только с помощью",
    ),
    ...
    "ThereIsNothingYetCreateYourFirstNews":
        MessageLookupByLibrary.simpleMessage(
          "Пока ничего нет! Создай первую новость",
        ),
    ...
    "ThereNoUsersWhoHaveBoughtOfferYet": MessageLookupByLibrary.simpleMessage(
      "Пока еще нет пользователей, которые купили этот оффер",
    ),
    ...
    "TicketFrom": m101,
    "TicketInfo": MessageLookupByLibrary.simpleMessage("Информация о билете"),
    ...
    "Timing": MessageLookupByLibrary.simpleMessage("Расписание"),
    ...
    "ToAllowAccessGoToSettings": MessageLookupByLibrary.simpleMessage(
      "Чтобы разрешить push-уведомления, зайди в настройки телефона",
    ),
    "ToBecomeAnInfluencerYouNeedToDo": MessageLookupByLibrary.simpleMessage(
      "Чтобы стать инфлюенсером нужно выполнить",
    ),
    "ToExtendYourUseSelectPayment": MessageLookupByLibrary.simpleMessage(
      "Чтобы продлить срок использования, выбери пункт оплата",
    ),
    ...
    "ToOpenTheNextSetOfToolsYouNeedToDo": MessageLookupByLibrary.simpleMessage(
      "Чтобы открыть следующий набор инструментов, нужно сделать",
    ),
    ...
    "Upsales": MessageLookupByLibrary.simpleMessage("Допродажи"),
    ...
    "UseOurToolsToImproveIt": MessageLookupByLibrary.simpleMessage(
      "Используй инструменты, чтобы улучшить его",
    ),
    ...
    "WeArePreparingChallengesForTomorrow": MessageLookupByLibrary.simpleMessage(
      "Мы готовим челленджи на завтра, приходи позже",
    ),
    ...
    "WriteTheAnswer": MessageLookupByLibrary.simpleMessage("Напиши ответ"),
    "WrongSecurityCode": MessageLookupByLibrary.simpleMessage("Неверный код"),
    "XCouldNotBeEmpty": m114,
    "XDay": m115,
    "XHour": m116,
    "XInvitesY": m117,
    "XIsRequired": m118,
    "XSuccessfullyActivated": m119,
    "XSuccessfullyCreated": m120,
    "XSuccessfullyUpdated": m121,
    "XWeek": m122,
    "XYearsPlus": m123,
    ...
    "YouCanSeeYourXPromotionMenu": m126,
    ...
    "YouHaveUnpaidTickets": MessageLookupByLibrary.simpleMessage(
      "У тебя есть неоплаченные билеты, хочешь оплатить их в разделе Мои букинги?",
    ),
    ...
    "YouNeedSelectMethods": MessageLookupByLibrary.simpleMessage(
      "Выбери один или несколько способов",
    ),
    ...
    "YouSentInvitationToNPeople": m127,
    "YouSharedTicket": MessageLookupByLibrary.simpleMessage(
      "Вы поделились билетом",
    ),
    "YouSureToDeleteX": m128,
    "YouWillNoLongerSendMessagesTo": m129,
    ...
    "YourIndicatorsHasSetTheBarHighItCanBe":
        MessageLookupByLibrary.simpleMessage(
          "Показатели установили высокую планку! Они могут быть",
        ),
    ...
    "YourNewTools": MessageLookupByLibrary.simpleMessage(
      "Твои новые инструменты",
    ),
    "YourNiche": MessageLookupByLibrary.simpleMessage("Твоя ниша"),
    "YourNotificationWillBeShown": MessageLookupByLibrary.simpleMessage(
      "Уведомление будет показываться 3 раза в неделю в течение указанного срока действия, не более 1 показа на человека.",
    ),
    "YourOfferHasAlreadyBeenPublishedToYourAudience":
        MessageLookupByLibrary.simpleMessage(
          "Оффер уже был опубликован для аудитории, изменяя или удаляя его, ты несёшь ответственность за потенциальную негативную реакцию.",
        ),
    "YourOfferWillShown1Time": MessageLookupByLibrary.simpleMessage(
      "Оффер будет показан 1 раз и включен в список предложений вашей аудитории. Он исчезнет после окончания события.",
    ),
    ...
    "YourReminderShown1TimeOnTheSpecifiedDate":
        MessageLookupByLibrary.simpleMessage(
          "Твоё напоминание показывается 1 раз в указанную дату.",
        ),
    "YourShowUpRatio": MessageLookupByLibrary.simpleMessage(
      "Твой Show up ratio",
    ),
    "YourStartNotificationWillBeShownXTimes": m130,
