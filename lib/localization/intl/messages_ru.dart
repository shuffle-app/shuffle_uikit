...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m71(amount) => "Читать ${amount}";

  static String m72(message) => "Ответ на ${message}";
  ...
  static String m78(type) => "Выбрать ${type}";
  ...
  static String m80(x) => "Показать ${x} в профиле";
  ...
  static String m85(x) => "Статус: ${x} - Доступно";

  static String m86(x) =>
      "Статус ${x} - Доступ ограничен или страница не найдена";

  static String m87(separator) => "Расскажи${separator}о себе";
  ...
  static String m90(date) => "Топ событий на ${date}";

  static String m91(amountOfTopDonators, multiplier) =>
      "Топовые ${amountOfTopDonators} донаторы получают x${multiplier} поинтов";

  static String m92(separator) => "Топовый контент${separator}от";

  static String m93(x) => "Вы отправляете ${x} на модерацию";

  static String m94(type) => "Чтобы пользоваться этим нужен ${type} аккаунт";

  static String m95(forNMoney) => "Купить ${forNMoney}";
  ...
  static String m99(value) => "${value} не может быть пустым";

  static String m100(x, y) => "${x} приглашает ${y}";

  static String m101(title) => "${title} требуется";

  static String m102(x) => "${x} успешно активировано";

  static String m103(x) => "${x} успешно созданно";

  static String m104(value) => "${value} успешно обновлено";
