...
class UiKitFingerPrintButton extends StatefulWidget {
  const UiKitFingerPrintButton({
    super.key,
...
class _UiKitFingerPrintButtonState extends State<UiKitFingerPrintButton>
    with TickerProviderStateMixin {
